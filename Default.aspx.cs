...
namespace WdS.ElioPlus
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        public string Ip
        {
            get
            {
                return ViewState["Ip"] == null ? "" : ViewState["Ip"].ToString();
            }
            set
            {
                ViewState["Ip"] = value;
        ...
        private void UpdateStrings()
        {
            try
            {
                ...
                Label97.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "76")).Text;
                Label98.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "77")).Text;
                Label99.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "78")).Text;
                Label100.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "79")).Text;
                Label101.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "80")).Text;
                Label102.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "81")).Text;
                Label103.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "82")).Text;
                Label104.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "83")).Text;
                Label105.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "84")).Text;
                Label109.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "88")).Text;
                Label110.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "89")).Text;
                Label111.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "prmmaster", "label", "90")).Text;
