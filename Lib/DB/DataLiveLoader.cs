...
{
    public class DataLiveLoader<T>
    {
        public DBLiveSession Session { get; set; }

        public DataLiveLoader(DBLiveSession session)
        {
        ...
        public int GetIdentity(DBLiveSession session)
        {
