<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardRandstadDealsViewPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardRandstadDealsViewPage" %>
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center py-2">
                                                    <div class="d-flex align-items-center mr-6" style="margin-top: -15px;">
                                                        <div class="mr-6">
                                                    ...
                                                    <div class="d-flex align-items-center mr-6">
                                                        <div class="mr-8">
                                                            ...
                                                            <span class="btn btn-sm btn-text text-uppercase font-weight-bold">
                                                                ...
                                                                <asp:DropDownList ID="DdlDealResultEdit" Width="235" CssClass="form-control" runat="server" />
                                                            </span>
                                                        </div>
                                                        <div class="mr-8">
                                                            <div class="font-weight-bold">
                                                    ...
                                                    <div class="d-flex align-items-center mr-2" style="margin-top: -15px;">
