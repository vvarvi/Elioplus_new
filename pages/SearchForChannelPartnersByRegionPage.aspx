<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="SearchForChannelPartnersByRegionPage.aspx.cs" Inherits="WdS.ElioPlus.pages.SearchForChannelPartnersByRegionPage" %>
                ...
                <div class="gap-40px lg:gap-60px flex flex-col justify-center items-center w-full">
                    <div class="gap-20px lg:gap-30px flex flex-col justify-center items-center w-full">
                        ...
                        <div class="flex justify-center">
                            <div class="flex gap-10px w-full lg:w-[760px] max-w-full pt-5px pr-5px pb-5px pl-15px bg-white shadow-card rounded-40px overflow-hidden" method="POST" action="SearchForChannelPartnersByRegionPage.aspx">
