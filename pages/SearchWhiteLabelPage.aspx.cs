...
{
    public partial class SearchWhiteLabelPage : System.Web.UI.Page
    {
        ...
        private void FillRepeaters()
        {
            try
            {
                ...
                DataSet ds = Sql.GetSubIndustriesGroupItemssForAllIndustryGroupsByLinkPrefix("/white-label/vendors/", session);
        ...
        private void SetBreadCrumb()
        {
            ...
            aBCrCategory.HRef = ControlLoader.WhiteLabelPartnerPrograms;

            Label lblCategory = new Label();
            lblCategory.Text = "White Label Partner Programs";
        ...
        private DataTable GetSubIndustriesById(int id)
        {
            ...
            {
                string link = "/white-label/vendors/" + item.Description.Replace("&", "and").Replace(" ", "_").ToLower();
