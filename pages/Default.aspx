<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Elioplus.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WdS.ElioPlus.pages.Default" %>
            ...
            <main class="transition-all duration-200">
                        ...
                        <div class="grid-cols-1 lg:grid-cols-2 grid gap-30px">
                            <div class="row-start-2 lg:row-start-1 gap-20px lg:gap-30px flex flex-col">
                                <div class="text-center lg:text-left gap-10px lg:gap-15px flex flex-col">
                                    ...
                                    <h2 class="text-2xl lg:text-3xl font-bold font-inter text-blue"><asp:Label ID="Label2" runat="server" /></h2>
                                </div>
                                <p class="text-base lg:text-body text-center lg:text-left"><asp:Label ID="Label3" runat="server" /></p>
                                <div class="flex items-center gap-10px xl:gap-15px flex-col lg:flex-row">
                                    <a id="aBrowseCompanies" runat="server" class="btn large font-bold text-sm xl:text-base"><span><asp:Label ID="Label4" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                    </defs></svg>
                                        ...
                                        <span><asp:Label ID="Label5" runat="server" /></span></a>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="gap-50px lg:gap-80px flex flex-col">
                            <div class="flex flex-col gap-10px text-center items-center">
                                <h3 class="text-2xl lg:text-3xl font-bold font-inter"><asp:Label ID="Label6" runat="server" /></h3>
                                <p class="w-[770px] max-w-full text-base lg:text-body"><asp:Label ID="Label7" runat="server" /><strong><asp:Label ID="Label8" runat="server" /></strong><asp:Label ID="Label9" runat="server" /><strong><asp:Label ID="Label10" runat="server" /></strong><asp:Label ID="Label11" runat="server" /></p>
                            </div>
                            <div class="gap-30px lg:gap-60px flex w-full flex-col">
                                <div class="gap-30px lg:gap-0 flex w-full justify-between flex-wrap">
                                    <a class="w-[380px] max-w-full bg-white shadow-card overflow-hidden rounded-10px" href="/channel-partner-recruitment">
                                        <div class="h-[250px] bg-gray flex items-center justify-center">
                                            <img src="/assets_out/images/products/partner-recruitment.svg">
                                        </div>
                                        <div class="gap-10px lg:gap-15px py-20px lg:py-30px px-20px lg:px-25px bg-white flex flex-col">
                                            <h3 class="text-lg lg:text-2xl font-bold font-inter"><asp:Label ID="Label12" runat="server" /></h3>
                                            <p class="text-sm lg:text-base"><asp:Label ID="Label13" runat="server" /></p>
                                            <div class="btn font-bold text-sm text-blue">
                                                <span><asp:Label ID="Label14" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                                </defs></svg>
                                        ...
                                        <div class="h-[250px] bg-gray flex items-center justify-center">
                                            <img src="/assets_out/images/products/partner-relationship-manager.png">
                                        </div>
                                        <div class="gap-10px lg:gap-15px py-20px lg:py-30px px-20px lg:px-25px bg-white flex flex-col">
                                            <h3 class="text-lg lg:text-2xl font-bold font-inter"><asp:Label ID="Label15" runat="server" /></h3>
                                            <p class="text-sm lg:text-base"><asp:Label ID="Label16" runat="server" /></p>
                                            <div class="btn font-bold text-sm text-blue">
                                                <span><asp:Label ID="Label17" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                                </defs></svg>
                                        ...
                                        <div class="h-[250px] bg-gray flex items-center justify-center">
                                            <img src="/assets_out/images/products/intent-signals.svg">
                                        </div>
                                        <div class="gap-10px lg:gap-15px py-20px lg:py-30px px-20px lg:px-25px bg-white flex flex-col">
                                            <h3 class="text-lg lg:text-2xl font-bold font-inter"><asp:Label ID="Label18" runat="server" /></h3>
                                            <p class="text-sm lg:text-base"><asp:Label ID="Label19" runat="server" /></p>
                                            <div class="btn font-bold text-sm text-blue">
                                                <span><asp:Label ID="Label20" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                                </defs></svg>
                                ...
                                <div class="gap-30px lg:gap-50px flex w-full justify-center flex-wrap">
                                    <a class="w-[380px] max-w-full bg-white shadow-card overflow-hidden rounded-10px" href="/referral-software">
                                        <div class="h-[250px] bg-gray flex items-center justify-center">
                                            <img src="/assets_out/images/products/referral-software.svg">
                                        </div>
                                        <div class="gap-10px lg:gap-15px py-20px lg:py-30px px-20px lg:px-25px bg-white flex flex-col">
                                            <h3 class="text-lg lg:text-2xl font-bold font-inter"><asp:Label ID="Label21" runat="server" /></h3>
                                            <p class="text-sm lg:text-base"><asp:Label ID="Label22" runat="server" /></p>
                                            <div class="btn font-bold text-sm text-blue">
                                                <span><asp:Label ID="Label23" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                                </defs></svg>
                ...
                <section class="bg-white">
                    <div class="container">
                        <div class="flex flex-col gap-40px">
                            <div class="flex flex-col gap-10px text-center items-center">
                                <h3 class="text-2xl lg:text-3xl font-bold font-inter"><asp:Label ID="Label27" runat="server" /></h3>
                                <p class="w-[855px] max-w-full text-base lg:text-body"><asp:Label ID="Label28" runat="server" /><asp:Label ID="Label29" runat="server" /></p>
                            </div>
                            ...
                            <div class="flex justify-center items-center flex-col lg:flex-row gap-10px xl:gap-20px">
                                <a id="aViewAllCompanies" runat="server" class="btn large font-bold text-sm xl:text-base"><span><asp:Label ID="Label31" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                </defs></svg>
                                    ...
                                    <span><asp:Label ID="Label32" runat="server" /></span></a>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="gap-30px lg:gap-50px flex flex-col">
                            <div class="flex flex-col gap-10px text-center items-center text-white">
                                <h3 class="text-2xl lg:text-3xl font-bold font-inter"><asp:Label ID="Label33" runat="server" /></h3>
                                <p class="w-[780px] max-w-full text-base lg:text-body"><asp:Label ID="Label34" runat="server" /></p>
                            </div>
                            <div class="flex-col lg:flex-row gap-30px lg:gap-50px flex text-center items-center justify-center">
                                ...
                                <div class="w-[250px] max-w-full py-15px lg:py-30px bg-white rounded-10px shadow-card flex flex-col gap-15px items-center">
                                    ...
                                    <div class="flex flex-col">
                                        <h4 class="text-base lg:text-body font-bold"><asp:Label ID="Label38" runat="server" /></h4>
                                        <p class="text-sm"><asp:Label ID="Label36" runat="server" /></p>
                                    </div>
                                </div>
                                <div class="w-[250px] max-w-full py-15px lg:py-30px bg-white rounded-10px shadow-card flex flex-col gap-15px items-center">
                                    <div class="w-[60px] h-[60px] lg:w-[85px] lg:h-[85px] p-10px rounded-full bg-lightBlue2 flex items-center justify-center">
                                    ...
                                    <div class="flex flex-col">
                                        <h4 class="text-base lg:text-body font-bold"><asp:Label ID="Label39" runat="server" /></h4>
                                        <p class="text-sm"><asp:Label ID="Label37" runat="server" /></p>
                                    </div>
                                </div>
                            </div>
                            <div class="flex justify-center items-center gap-10px xl:gap-20px">
                                <a id="aPartnerPortalB" runat="server" class="btn font-bold text-sm bg-white"><span><asp:Label ID="Label40" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                </defs></svg>
                                </a>
                            </div>
                        </div>
                ...
                <section class="bg-white">
                    <div class="container">
                        <div class="gap-30px lg:gap-50px flex flex-col">
                            <div class="flex flex-col gap-10px text-center items-center">
                                <h3 class="text-2xl lg:text-3xl font-bold font-inter"><asp:Label ID="Label41" runat="server" /></h3>
                                <p class="w-[780px] max-w-full text-base lg:text-body"><asp:Label ID="Label42" runat="server" /></p>
                            </div>
                            <div class="gap-7px lg:gap-15px countries flex justify-center flex-wrap">
                                <a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/north-america/united-states/channel-partners">
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label43" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label44" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label45" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label46" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label47" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label48" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label49" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label50" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label51" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label52" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label53" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label54" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label55" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label56" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label57" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label58" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label59" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label60" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label61" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label62" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label63" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label64" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label65" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label66" runat="server" /></h5>
                                    ...
                                    <h5 class="text-xs lg:text-base-15 transition-all duration-200 hover:text-blue font-bold"><asp:Label ID="Label67" runat="server" /></h5>
                                </a>
                            </div>
                            <div class="flex justify-center items-center gap-10px xl:gap-20px">
                                <a id="aSearchChannelPartners" runat="server" class="btn font-bold text-sm bg-white"><span><asp:Label ID="Label68" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                </defs></svg>
                                </a>
                            </div>
                        </div>
                ...
                <section>
                    <div class="container">
                        <div class="gap-25px lg:gap-50px flex flex-col">
                            <div class="flex flex-col gap-10px text-center items-center">
                                <h3 class="text-2xl lg:text-3xl font-bold font-inter"><asp:Label ID="Label69" runat="server" /></h3>
                                <p class="w-[690px] max-w-full text-base lg:text-body"><asp:Label ID="Label70" runat="server" /></p>
                            </div>
                                    ...
                                    <div class="bg-white rounded-10px shadow-card flex flex-col gap-25px py-30px px-25px">
                                        <div class="justify-center lg:justify-start text-center lg:text-left flex gap-15px flex-wrap">
                                            <div class="w-[55px] h-[55px] rounded-full bg-lightBlue2 flex items-center justify-center">
                                                <img src="/assets_out/images/homepage/user.svg" alt="Len B.profile image">
                                            </div>
                                            <div class="flex flex-col">
                                                <h5 class="text-base lg:text-lg font-semibold font-inter text-blue">Len B.</h5>
                                                <p class="text-sm lg:text-base text-textGray">Director of Global Channel Development Computer Software</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="gap-5px mdl:gap-15px justify-center lg:justify-start text-center lg:text-left flex flex-col">
                                            ...
                                            <p class="text-sm lg:text-base">Elioplus PRM is helping us expand our reseller network throughout the world by providing not only leads for us to contact but also guidance on targeting and messaging.</p>
                                        </div>
                                ...
                                <div class="p-20px">
                                    <div class="bg-white rounded-10px shadow-card flex flex-col gap-25px py-30px px-25px">
                                        <div class="justify-center lg:justify-start text-center lg:text-left flex gap-15px flex-wrap">
                                            ...
                                            <div class="flex flex-col">
                                                <h5 class="text-base lg:text-lg font-semibold font-inter text-blue"><asp:Label ID="Label71" runat="server" /></h5>
                                                <p class="text-sm lg:text-base text-textGray"><asp:Label ID="Label72" runat="server" /></p>
                                            </div>
                                        </div>
                                        <div class="divider"></div>
                                        <div class="gap-5px mdl:gap-15px justify-center lg:justify-start text-center lg:text-left flex flex-col">
                                            <h4 class="text-base lg:text-body font-inter font-bold"><asp:Label ID="Label73" runat="server" /></h4>
                                            <p class="text-sm lg:text-base"><asp:Label ID="Label74" runat="server" /></p>
                                        </div>
                                        <div class="justify-center lg:justify-end flex">
                                            <a class="btn font-bold text-sm bg-white" href="https://www.capterra.com/p/171144/Elioplus-PRM/reviews/" target="_blank"><span><asp:Label ID="Label75" runat="server" /></span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                                            </defs></svg>
                                            </a>
                                        </div>
                                    </div>
