...
{
    public partial class RecruitmentChannelPartnerAutomatePage : System.Web.UI.Page
    {
        ...
        {
            aContactusAuto.HRef = aEnterpriseContact.HRef = ControlLoader.ContactUs;

            if (vSession.User == null)
            {
                aGetStartedFreeB.Visible = true;
                aGetStartedFree.HRef = aGetStartedFreeB.HRef = aGrowthAuto.HRef = aStartupAuto.HRef = aGetStartedAuto.HRef = ControlLoader.SignUp;
            }
            else
            {
                ...
                {
                    aChekoutGrowthAuto.Visible = aChekoutStartupAuto.Visible = true;

                    aGrowthAuto.Visible = aStartupAuto.Visible = aGetStartedAuto.Visible = false;
