...
{
    public partial class MessageQuotePage : System.Web.UI.Page
    {
        ...
        private void UpdateStrings()
        {
            try
            {
                ...
                {
                    if (pgTitle != null)
                        pgTitle.InnerText = "Send message quote request to companies you are interested in";
                ...
                if (UserID > 0)
                {
                    ...
                    else if (divStepTwo.Visible)
                    {
                        ...
                        if (HdnLeadId.Value == "0")
                        {
                            ...
                            lead.RfpMessageCompanyIdIsFor = UserID.ToString();
                    ...
                    throw new Exception("No User found to send message Quote!");
            }
            catch (Exception ex)
            {
                Logger.DetailedError(Request.Url.ToString(), ex.Message.ToString(), ex.StackTrace.ToString());
