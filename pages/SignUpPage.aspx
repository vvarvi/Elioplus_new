<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="SignUpPage.aspx.cs" Inherits="WdS.ElioPlus.pages.SignUpPage" %>

<%@ Register Src="~/Controls/AlertControls/MessageControl.ascx" TagName="MessageControl" TagPrefix="controls" %>

<asp:Content ID="SignUpHead" ContentPlaceHolderID="HeadContent" runat="server">
...
<asp:Content ID="SignUpMain" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="container">
                        <div class="gap-30px lg:gap-50px flex flex-col justify-center items-center">
                            <div class="flex flex-col gap-10px text-center items-center w-full">
                                ...
                                <p class="text-base lg:text-body w-[546px] max-w-full">Enter your details below to sign up for your ElioPlus account. It will take less than 2 minutes and it's free.</p>
                            </div>
                            <div class="flex flex-col gap-25px text-center items-center w-full">
                                <div class="w-[460px] max-w-full p-20px lg:p-40px flex flex-col bg-white shadow-card rounded-10px justify-center items-center" method="POST">
                                    <div class="w-full flex flex-col gap-30px">
                                        ...
                                        <div class="w-full flex flex-col" style="margin-bottom: 15px;">
