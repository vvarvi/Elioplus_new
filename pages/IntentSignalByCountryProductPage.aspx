<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="IntentSignalByCountryProductPage.aspx.cs" Inherits="WdS.ElioPlus.pages.IntentSignalByCountryProductPage" %>
...
<asp:Content ID="HowItWorksHead" ContentPlaceHolderID="HeadContent" runat="server">
    <meta id="metaDescription" runat="server" name="description" content="Get quotation requests and intent data for thousands of products and technologies exclusively for local IT companies around the world." />
    <meta id="metaKeywords" runat="server" name="keywords" content="lead generation, intent data, quotes for IT companies" />
</asp:Content>
                ...
                <div class="grid-cols-1 lg:grid-cols-2 grid gap-30px">
                    <div class="row-start-2 lg:row-start-1 gap-20px lg:gap-30px flex flex-col justify-center">
                        <div class="text-center lg:text-left gap-10px lg:gap-15px flex flex-col">
                            ...
                            <h2 class="text-2xl lg:text-3xl font-bold font-inter text-blue">Leads & RFQs generation network.</h2>
                        </div>
                        <p class="text-base lg:text-body text-center lg:text-left">The Intent Signals partner program is for agencies looking to expand their offerings and help their clients grow their sales pipeline. Whether you offer marketing or sales services for your clients we can help you grow your business faster. Win new customers, expand your services or upsell your current clients.</p>
                    ...
                    <div class="flex justify-center items-center">
                        <img class="max-w-[250px] lg:max-w-full" src="/assets_out/images/intent-signals/opener.svg" alt="Intent Signals, Leads &amp; RFQs generation network by Elioplus.">
                    </div>
                </div>
            </div>
        ...
        <section class="bg-white" id="features">
            <div class="container">
                <div class="gap-50px lg:gap-80px flex flex-col">
                    <div class="flex flex-col gap-10px text-center items-center">
                        <h3 class="text-2xl lg:text-3xl font-bold font-inter">Features that matter</h3>
                        <p class="w-full text-base lg:text-body">Avoid a ton of features that make your life difficult. Through Elioplus PRM you are focusing on your channel partner's productivity and needs through collaboration and incentivization.</p>
                    </div>
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        <div class="flex items-center justify-center">
                            <img class="max-w-[250px] lg:max-w-full" src="/assets_out/images/intent-signals/high-leads.svg" alt="igh intent leads &amp; RFQs with the Elioplus Intent Signals Solution" loading="lazy">
                        </div>
                    ...
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        <div class="row-start-2 lg:row-start-1 gap-20px lg:gap-30px flex flex-col justify-center">
                            ...
                            <p class="w-full text-base lg:text-body text-center lg:text-left">Your profile will be recommended on the top spot of all relevant landing pages on our network based to help you drive high quality traffic to your website. Potential clients can also reach out directly to your company for quotation that is shared exclusively to you.</p>
                        </div>
                        <div class="flex items-center justify-center">
                            <img class="max-w-[250px] lg:max-w-full" src="/assets_out/images/intent-signals/featured.svg" alt="Get featured on our network with the Elioplus Intent Signals Solution" loading="lazy">
                        </div>
                    </div>
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        <div class="flex items-center justify-center">
                            <img class="max-w-[250px] lg:max-w-full" src="/assets_out/images/intent-signals/campaigns.svg" alt="Start your campaigns with the Elioplus Intent Signals Solution" loading="lazy">
                        </div>
                        <div class="gap-20px lg:gap-30px flex flex-col justify-center">
            ...
            <div class="container">
                <div class="gap-30px lg:gap-50px flex flex-col">
                    ...
                    <div class="w-full overflow-x-auto flex flex-col rounded-10px overflow-hidden shadow-card">
                                        ...
                                        <tr class="text-sm lg:text-base font-medium mdl:font-bold">
                                            ...
                                            <td>
                                                <div class="flex w-full justify-start">
                                                    <a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="#">
                                            ...
                                            <td>
                                                ...
                                                <asp:Image ID="ImgInfo" Visible="false" CssClass="w-[15px] mdl:w-[20px]" Style="cursor: pointer;" AlternateText="info icon" ImageUrl="../assets/images/global/info.svg" Width="20" Height="20" runat="server" />
                        ...
                        <a id="aLoadLess" runat="server" visible="false" onserverclick="aLoadLess_ServerClick" class="text-sm mdl:text-base table-load bg-gray2 text-center text-blue font-bold py-20px w-full">LOAD LESS INTENT SIGNALS
                        </a>
                        <a id="aLoadMore" runat="server" visible="false" onserverclick="aLoadNext_ServerClick" class="text-sm mdl:text-base table-load bg-gray2 text-center text-blue font-bold py-20px w-full">LOAD MORE INTENT SIGNALS
                        </a>
                    </div>
                ...
                <div class="gap-50px lg:gap-80px flex flex-col">
                    <div class="gap-30px lg:gap-50px flex flex-col">
                        ...
                        <div class="gap-7px lg:gap-15px countries flex justify-center flex-wrap">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/nigeria">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/new-zealand">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/philippines">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/france">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/germany">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/italy">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/netherlands">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/poland">
                            ...
                            </a><a class="country bg-white overflow-hidden rounded-30px p-5px pr-15px flex gap-5px items-center border-gray border-2 w-fit" href="/intent-signals/spain">
                    ...
                    <div class="gap-30px lg:gap-50px flex flex-col">
                        <h3 class="text-2xl lg:text-3xl font-bold font-inter text-center">Popular Technologies</h3>
                        <div class="flex-col sm:flex-row gap-15px md:gap-25px mdl:gap-50px flex justify-center w-full">
                            ...
                            <div class="flex-row sm:flex-col justify-center gap-10px flex-wrap flex">
                                ...
                                </a><a class="w-max smw-full flex gap-10px items-center" href="/intent-signals/ringcentral">
                                    <div class="hidden sm:block w-[8px] h-[8px]  sm:w-[15px] sm:h-[15px] rounded-full bg-blue"></div>
            ...
            <div class="container">
                <div class="gap-30px lg:gap-50px flex flex-col">
                    <div class="flex flex-col gap-10px text-center items-center text-white">
                        ...
                        <p class="w-[780px] max-w-full text-base lg:text-body">Intent Signals is as simple as it can. Get started in less than a minute</p>
                    </div>
                ...
                <div class="gap-50px lg:gap-80px flex flex-col">
                    ...
                    <div class="grid-cols-1 lg:grid-cols-7-5 text-img-row grid gap-30px">
                        ...
                        <div class="flex items-center justify-center pl-30px">
                            <img class="max-w-[250px] lg:max-w-full" src="/assets_out/images/intent-signals/leadsFrom.svg" alt="Where we get Leads and RFQs data for Elioplus Intent Signals software solution" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-[360px] max-w-full mx-auto lg:mx-0 bg-white shadow-card rounded-20px p-30px flex flex-col gap-25px">
                            ...
                            <div class="flex flex-col gap-15px w-full">
                                ...
                                <div class="flex flex-col gap-5px w-full">
                                    ...
                                    <div class="flex items-center gap-5px">
                                        <div class="w-[20px] h-[20px] flex items-center justify-center">
                                            <img src="/assets_out/images/pricing/check.svg" alt="Included feature for Enreach Your Leads (Cooming Soon)" loading="lazy" />
                                        </div>
                                        <div class="text-[15px]">Enreach Your Leads (Cooming Soon)</div>
                                    </div>
                                </div>
                            </div>
                        </div>
