...
{
    public partial class SearchSystemIntegratorPage : System.Web.UI.Page
    {
        ...
        private void FillRepeaters()
        {
            try
            {
                ...
                DataSet ds = Sql.GetSubIndustriesGroupItemssForAllIndustryGroupsByLinkPrefix("/system-integrators/vendors/", session);
        ...
        private void SetBreadCrumb()
        {
            ...
            aBCrCategory.HRef = ControlLoader.SystemIntegratorsPartnerPrograms;

            Label lblCategory = new Label();
            lblCategory.Text = "Systems Integrators Partner Programs";
        ...
        private DataTable GetSubIndustriesById(int id)
        {
            ...
            {
                string link = "/system-integrators/vendors/" + item.Description.Replace("&", "and").Replace(" ", "_").ToLower();
