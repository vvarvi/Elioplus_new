<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="ResetPasswordPage.aspx.cs" Inherits="WdS.ElioPlus.pages.ResetPasswordPage" %>
...
<asp:Content ID="HowItWorksHead" ContentPlaceHolderID="HeadContent" runat="server">
    <meta name="description" content="Reset your password on Elioplus and find new great partnership opportunities from software and SaaS companies, vendors, resellers and manage your channel partners" />
    <meta name="keywords" content="partner program, partnership criteria, promote my partner program, value added resellers, white label software, SaaS" />
</asp:Content>
                    ...
                    <div class="flex flex-col gap-25px text-center items-center w-full">
                        <div class="w-[460px] max-w-full p-20px lg:p-40px flex flex-col bg-white shadow-card rounded-10px justify-center items-center" method="POST">
                            <div class="w-full flex flex-col gap-30px">
                                <div id="divContact" runat="server" class="w-full flex flex-col gap-30px">
