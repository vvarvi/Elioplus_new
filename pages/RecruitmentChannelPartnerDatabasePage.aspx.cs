...
{
    public partial class RecruitmentChannelPartnerDatabasePage : System.Web.UI.Page
    {
        ...
        private void SetLinks()
        {
            ...
            if (vSession.User == null)
            {
                ...
                aGetStartedFree.HRef = aGetStartedFreeB.HRef = aGrowthData.HRef = aStartupData.HRef = ControlLoader.SignUp;
            }
            else
            {
                ...
                {
                    aChekoutGrowthData.Visible = aChekoutStartupData.Visible = true;

                    aGrowthData.Visible = aStartupData.Visible = false;
