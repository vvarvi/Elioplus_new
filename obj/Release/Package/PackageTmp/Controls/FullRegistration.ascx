<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FullRegistration.ascx.cs" Inherits="WdS.ElioPlus.Controls.FullRegistration" %>
    ...
    <asp:Panel ID="PnlRegister" runat="server">
        <telerik:RadPanelBar ID="RpbRegistrationSteps" OnItemClick="RpbRegistrationSteps_ItemClick" ExpandMode="SingleExpandedItem" Width="100%" runat="server">
            <Items>
                    ...
                    <Items>
                        <telerik:RadPanelItem>
                            <ItemTemplate>
                                ...
                                <div class="col-md-12 skin skin-flat form-body form-group input-group-large icheck-list" style="padding-left: 38%;">
                                ...
                                <div class="col-md-12" style="text-align: center; margin-top: -15px; margin-bottom: 20px;">
                                    <strong>
                                        <asp:Label ID="LblTypeInfo" runat="server" Font-Size="14px" ForeColor="SeaGreen" Text="Please select your company type from the options above!" />
                                ...
                                <div class="form col-md-12" style="text-align: center;">
                                    ...
                                    <div class="col-md-8" style="text-align: center; margin-left: 17%; margin-right: 17%; margin-bottom: 20px;">
                                        <asp:UpdatePanel runat="server" ID="LogoUpdatePanel">
                                            <ContentTemplate>
                                                <div id="divLogoInfo" runat="server" class="col-md-8" style="margin-top: 5px; width: 250px; font-size: 16px; margin-bottom: 10px">
                                                    <asp:Label ID="LblLogoInfo" runat="server" Text="Upload Company Logo" />
                                                    <div id="divInfo" runat="server" class="fa-item col-md-3 col-sm-4" style="float: right; cursor: pointer;">
                                                        <i class="fa fa-info-circle"></i>
                                                    </div>
                                                    <telerik:RadToolTip ID="RttImageInfo" TargetControlID="divInfo" Font-Bold="true" Position="TopRight" Animation="Fade" Text="Logo is required(*), must be of type '.png, jpg', maximum size accepted is '20 kb' and ideal dimensions are '200x100 px'. Image is uploaded by clicking 'Next'." runat="server" />
                                                </div>
                                    ...
                                    <div id="divLogoFailure" runat="server" visible="false" class="alert alert-danger col-md-8" style="font-size: 16px; margin-left:17%;">
                                        <strong>
                ...
                <telerik:RadPanelItem BackColor="#5995bb" ForeColor="White" Visible="false" runat="server" Selected="true">
                    <Items>
                                ...
                                <div class="skin skin-flat form" style="text-align: left">
                                    <asp:Panel ID="PnlIndustry" CssClass="form-body form-group" runat="server">
                                        <div class="portlet light bordered" style="padding-bottom: 0px; margin-bottom: 0px;">
                                            <div class="portlet-title" style="padding: 10px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                <asp:Label ID="Label7" Font-Size="20px" CssClass="pers-info-row" runat="server" Text="Select Industry" />
                                                <asp:Label ID="Label43" Font-Size="18px" CssClass="pers-info-row" Text="  (* You have to select at least one Industry category)" runat="server" />
                                            </div>
                                    ...
                                    <asp:Panel ID="PnlPartner" CssClass="form-body form-group" runat="server">
                                        <div class="portlet light bordered" style="padding-bottom: 0px; margin-bottom: 0px;">
                                            <div class="portlet-title" style="padding: 10px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                <asp:Label ID="Label19" Font-Size="20px" CssClass="pers-info-row" runat="server" Text="Company Type" />
                                                <asp:Label ID="Label46" Font-Size="18px" CssClass="pers-info-row" Text="  (* You have to select at least one category)" runat="server" />
                                            </div>
                                            <div class="portlet-body" style="padding-top: 0px;">
                                    ...
                                    <asp:Panel ID="PnlMarket" CssClass="form-body form-group" runat="server">
                                        <div class="portlet light bordered" style="padding-bottom: 0px; margin-bottom: 0px;">
                                            <div class="portlet-title" style="padding: 10px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                <asp:Label ID="Label25" Font-Size="20px" CssClass="pers-info-row" runat="server" Text="Market Specialisation" />
                                                <asp:Label ID="Label47" Font-Size="18px" CssClass="pers-info-row" Text="  (* You have to select at least one Market Specialisation category)" runat="server" />
                                            </div>
                                            <div class="portlet-body" style="padding-top: 0px;">
                                    ...
                                    <asp:Panel ID="PnlIntegrationProducts" CssClass="form-body form-group" runat="server">
                                        <div class="portlet light bordered" style="padding-bottom: 0px; margin-bottom: 0px;">
                                            <div class="portlet-title" style="padding: 10px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                <asp:Label ID="Label10" Font-Size="20px" CssClass="pers-info-row" runat="server" Text="Product Integrations" />
                                                <asp:Label ID="Label12" Font-Size="16px" CssClass="pers-info-row" Text="  (* Add your product integrations)" runat="server" />
                                            </div>
                                            <div class="portlet-body" style="padding: 20px 0px 20px 0px;">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-6" style="padding-top: 5px;">
                                                        <strong>
                                                            <asp:Label ID="LblIntegrationProducts" runat="server" />
                                                        </strong>
                                                    </div>
                                                    <div class="col-md-1" style="padding-top: 5px;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <asp:Label ID="LblIntegrationProductsError" Visible="false" CssClass="pers-info-row-error" Font-Size="18px" runat="server" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <asp:Panel ID="PnlSubIndustry" CssClass="form-body form-group" runat="server">
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption col-md-12" style="padding: 20px; font-size: 20px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                    <asp:Label ID="Label1" runat="server" Text="Select your categories - choose all that apply (maximum 15) (click on titles to expand)" />
                                                </div>
                                            </div>
                                                ...
                                                <div class="panel-group accordion scrollable" id="accordion2">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title" style="font-size: 18px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                        ...
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title" style="font-size: 18px; background: #5995bb; border-bottom: 1px solid #5995bb; color: #fff;">
                                                                <a class="accordion-toggle" aria-expanded="false" data-toggle="collapse" data-parent="#accordion2" href="#collapse_2_16">
                                                                    <asp:Label ID="Label13" runat="server" Text="Hardware" /></a>
                                                            </h4>
                                                        </div>
                ...
                <telerik:RadPanelItem BackColor="#5995bb" Visible="false" runat="server">
                    <Items>
                        <telerik:RadPanelItem>
                            <ItemTemplate>
                                <div class="row">
                                        ...
                                        <div class="portlet light form-fit bordered">
                                            <div class="portlet-body form">
                                                <form class="form-horizontal form-bordered">
                                                    <div class="col-md-12">
                                                        <div class="col-md-12 caption caption-subject" style="margin-bottom: 20px; margin-top: 25px;">
                                                            <asp:Label Font-Size="18px" ID="Label37" runat="server" />
                                                        </div>
                                                        <asp:TextBox ID="TbxOverview" Font-Size="16px" MaxLength="2500" placeholder="Minimum text required 400 characters, including spaces" CssClass="form-control" TextMode="MultiLine" Rows="10" runat="server" />
                                                        <div class="col-md-12 row row-fix">
                                                            <asp:Label ID="LblOverViewError" Font-Size="18px" CssClass="pers-info-row-error" runat="server" />
                                                        </div>
                                                    </div>
                                                    <div id="divDescription" runat="server" class="col-md-12">
                                                        <div class="col-md-12 caption caption-subject" style="margin-bottom: 20px; margin-top: 25px;">
                                                            <asp:Label Font-Size="18px" ID="Label11" runat="server" />
                                                        </div>
                                                        <asp:TextBox ID="TbxDescription" Font-Size="16px" MaxLength="2500" placeholder="Minimum text required 400 characters, including spaces" CssClass="form-control" TextMode="MultiLine" Rows="10" runat="server" />
                                                        <div class="col-md-12 row row-fix">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 50px; text-align: center;">
                                        <strong>
                                            <asp:Label ID="LblTerms" runat="server" ForeColor="#5995bb" Font-Size="16px" Text="By clicking Register you agree and accept the Terms and Conditions of our platform!" /></strong>
                                    </div>
                                </div>
                                <div class="form-body col-md-12" style="text-align: center; margin-bottom: 50px;">
