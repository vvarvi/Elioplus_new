<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InboxContent.ascx.cs" Inherits="WdS.ElioPlus.Controls.InboxContent" %>
            ...
            <th colspan="3">                
                <div class="btn-group input-actions">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a id="aMarkRead" runat="server" onserverclick="MarkRead_OnClick">
                                <i class="fa fa-pencil"></i><asp:Label ID="LblMarkAsRead" runat="server" />
                            </a>
                        </li>                        
                        <li class="divider"> </li>
                        <li>
