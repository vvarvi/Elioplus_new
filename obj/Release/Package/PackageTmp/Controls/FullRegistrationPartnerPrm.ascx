<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FullRegistrationPartnerPrm.ascx.cs" Inherits="WdS.ElioPlus.Controls.FullRegistrationPartnerPrm" %>
                    ...
                    <telerik:RadPanelItem>
                        <ItemTemplate>
                            ...
                            <div class="form col-md-12" style="text-align: center;">
                                ...
                                <div id="divLogoFailure" runat="server" visible="false" class="alert alert-danger col-md-6" style="font-size: 16px;">
                                    <strong>
