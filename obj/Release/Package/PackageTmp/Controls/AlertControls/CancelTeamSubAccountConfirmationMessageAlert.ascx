<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CancelTeamSubAccountConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.AlertControls.CancelTeamSubAccountConfirmationMessageAlert" %>
