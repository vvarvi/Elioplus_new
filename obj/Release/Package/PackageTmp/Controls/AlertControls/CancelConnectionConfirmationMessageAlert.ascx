<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CancelConnectionConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.AlertControls.CancelConnectionConfirmationMessageAlert" %>
