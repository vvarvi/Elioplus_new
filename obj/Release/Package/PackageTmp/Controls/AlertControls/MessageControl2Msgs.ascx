<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MessageControl2Msgs.ascx.cs" Inherits="WdS.ElioPlus.Controls.AlertControls.MessageControl2Msgs" %>

<div id="PnlMessage" runat="server" class="card bg-blue text-white gap-15px" style="margin-top: 30px; width: 100%;">
