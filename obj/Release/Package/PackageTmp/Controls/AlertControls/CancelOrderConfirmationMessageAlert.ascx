<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CancelOrderConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.AlertControls.CancelOrderConfirmationMessageAlert" %>
