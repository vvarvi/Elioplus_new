<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeleteOpportunityConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.AlertControls.DeleteOpportunityConfirmationMessageAlert" %>
