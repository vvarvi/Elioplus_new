<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcDealsDefaultControl.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.Deals.UcDealsDefaultControl" %>

<%@ Register Src="~/Controls/AlertControls/InfoMessageControl.ascx" TagName="InfoMessageControl" TagPrefix="controls" %>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div id="divVendorSettings" class="card-body" visible="false" style="" runat="server">
                            <div class="row">
                                <div class="col-xl-8">
                                    <asp:TextBox ID="TbxVendorDurationSetting" Width="333" placeholder="select default deal month duration" CssClass="form-control" MaxLength="10" runat="server"></asp:TextBox>
                            ...
                            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px;">
                                            <asp:Label ID="Label11" runat="server" Text="Status" />
                                        </th>
                                        <th style="width: 50px;">
