<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DACancelTeamSubAccountConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DACancelTeamSubAccountConfirmationMessageAlert" %>
                    ...
                    <form class="form-horizontal col-sm-12">
                        <div id="divInfo" runat="server" style="width: 100%;" class="alert alert-custom alert-light-info fade show">
                            ...
                            <div class="alert-text">
                                <strong>
                                    <asp:Label ID="LblMessage" Text="You are going to cancel your Premium Plan" runat="server" /><br />
                                    <br />
                                    <asp:Label ID="Label1" Text="Are you sure?" runat="server" />
                                </strong>
                            </div>
                        </div>
                    </form>
