<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DACancelConnectionConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DACancelConnectionConfirmationMessageAlert" %>
