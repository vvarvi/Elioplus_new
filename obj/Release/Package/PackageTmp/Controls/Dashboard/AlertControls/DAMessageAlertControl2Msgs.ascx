<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DAMessageAlertControl2Msgs.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DAMessageAlertControl2Msgs" %>
