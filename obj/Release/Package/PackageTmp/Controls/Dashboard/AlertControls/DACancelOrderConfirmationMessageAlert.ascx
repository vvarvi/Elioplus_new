<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DACancelOrderConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DACancelOrderConfirmationMessageAlert" %>
