<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="AdminElioFinancialIncomeFlowPage.aspx.cs" Inherits="WdS.ElioPlus.AdminElioFinancialIncomeFlowPage" %>
                    ...
                    <asp:Panel ID="PnlSearch" style="border-radius:5px; background-color:#F0F3CD;margin-bottom:10px; padding:30px 10px 30px 10px; margin:auto; position:relative;" runat="server">
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="width:120px;">
                                    <div style="padding:5px;">
                                        <asp:Label ID="LblIncomeAmount" CssClass="label_title" runat="server" />
                                    </div>
                                </td>
                                <td style="width:150px;">
                                    <div style="padding:5px;">
                                        <asp:TextBox ID="TbxIncomeAmount" Width="120" runat="server" /><asp:Label ID="LblIncomeAmountCurrency" Text="$" CssClass="label_title" runat="server" />
                                    </div>
                                </td>
                                <td style="width:140px;">
                                    <div style="padding:5px;">
                                        <asp:Label ID="LblIncomeSource" CssClass="label_title" runat="server" />
                                    </div>
                                </td>
                                <td style="width:150px;">
                                    <div style="padding:5px;">
                                        <asp:TextBox ID="TbxIncomeSource" Width="120" runat="server" />
                                    </div>
                                </td>
                                <td style="width:150px;">
                                    <div style="padding:5px;">
                            ...
                            <tr>
                                <td style="width:120px;">
                                    <div style="padding:5px;">
                                        <asp:Label ID="LblVat" CssClass="label_title" runat="server" />
                                    </div>
                                </td>
                                <td style="width:150px;">
                                    <div style="padding:5px;">
                                        <asp:TextBox ID="TbxVat" Width="120" runat="server" /> %
                                    </div>
                                </td>
                                <td style="width:120px;">
                                    <div style="padding:5px;">
                                        <asp:Label ID="LblIncomeVatAmount" CssClass="label_title" runat="server" />
                                    </div>
                                </td>
                                <td style="width:150px;">
                                    <div style="padding:5px;">
                                        <asp:TextBox ID="TbxIncomeVatAmount" ReadOnly="true" Width="120" runat="server" /><asp:Label ID="LblIncomeVatAmountCurrency" Text="$" CssClass="label_title" runat="server" />
                                    </div>
                                </td>                                     
                                <td style="width:150px;">
                                    <div style="padding:5px;">
                                        <asp:Label ID="LblIncomeWithNoVat" CssClass="label_title" runat="server" />
                                    </div>
                                </td>
                                <td style="width:200px;">
                                    <div style="padding:5px;">
                                        <asp:TextBox ID="TbxIncomeWithNoVat" ReadOnly="true" Width="120" runat="server" /><asp:Label ID="LblIncomeWithNoVatCurrency" Text="$" CssClass="label_title" runat="server" />                                    
                        ...
                        <telerik:RadGrid ID="RdgResults" BorderStyle="None" AllowPaging="true" PageSize="10" OnPageIndexChanged="RdgResults_PageIndexChanged" OnItemDataBound="RdgResults_OnItemDataBound" OnNeedDataSource="RdgResults_OnNeedDataSource" AutoGenerateColumns="false" runat="server" PagerStyle-Position="Bottom">
                            <MasterTableView>
                                ...
                                <Columns>                            
                                    ...
                                    <telerik:GridBoundColumn DataField="income_source" UniqueName="income_source" />
                                    ...
                                    <telerik:GridBoundColumn DataField="income_amount" UniqueName="income_amount" />
                                    <telerik:GridBoundColumn DataField="vat_amount" UniqueName="vat_amount" />
                                    <telerik:GridBoundColumn DataField="income_amount_with_no_vat" UniqueName="income_amount_with_no_vat" />                                
