<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuccessfulPaymentPage.aspx.cs" Inherits="WdS.ElioPlus.SuccessfulPaymentPage" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                        <div style="text-align: center; width: 280px;">
                                            <h3>
                                                <asp:Label ID="LblSuccessRegistration" runat="server" Text="We have received your payment.You have upgraded your account successfully!" />
                                            </h3>
                                        </div>
                                    </div>
