<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FullRegistration.aspx.cs" Inherits="WdS.ElioPlus.FullRegistration" %>
...
<body class="login-page access-page has-full-screen-bg">
    <form id="signUpForm" runat="server">
        ...
        <div class="upper-wrapper">
            ...
            <!--//header-->
            <!-- ******Signup Section****** -->
            <div class="signup-section access-section section">
                <div class="container">
                    <div class="row">
