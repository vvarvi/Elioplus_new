<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardGavsDealsViewPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardGavsDealsViewPage" %>
                                    ...
                                    <div class="example-preview">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                ...
                                                <div class="my-lg-0 my-1">
                                                    <div>
                                                        ...
                                                        <asp:Button ID="RbtnReOpen" Visible="false" OnClick="RbtnReOpen_Click" Text="Re Open" CssClass="btn btn-sm btn-light-success" runat="server" />
                                                        <asp:Button ID="RBtnSave" OnClick="BtnSave_OnClick" Visible="false" Text="Send" CssClass="btn btn-sm btn-light-success" runat="server" />
                                                        <asp:Button ID="RbtnWonClose" OnClick="RbtnWonClose_Click" Visible="false" Text="Close as Won" CssClass="btn btn-sm btn-primary" runat="server" />
                                                        <asp:Button ID="RbtnLostClose" OnClick="RbtnLostClose_Click" Visible="false" Text="Close as Lost" CssClass="btn btn-sm btn-danger" runat="server" />
                                                        <div id="divDublicateFlag" runat="server" visible="false" style="float: right; padding: 5px;">
                                                            <img src="/assets/media/svg/icons/Communication/Flag.svg" alt="Dublicate flag" />
                                                            <telerik:RadToolTip ID="RttDublicateInfo" TargetControlID="divDublicateFlag" Position="TopLeft" runat="server" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                                ...
                                                <div class="flex-grow-1 font-weight-bold text-dark-50">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="d-flex align-items-center mr-6">
                                                                <div class="mr-10">
                                                                    ...
                                                                    <span class="btn btn-sm btn-text text-uppercase font-weight-bold">
                                                                        <asp:Label ID="DdlDealResult" CssClass="form-control" runat="server" />
                                                                        <asp:DropDownList ID="DdlDealResultEdit" Enabled="false" Width="235" CssClass="form-control" runat="server" />
                                                                    </span>
                                                                </div>
                                                                <div class="mr-10">
                                                                    <div class="font-weight-bold">
                                                                    ...
                                                                    <span class="btn btn-sm btn-text text-uppercase font-weight-bold">
                                                                        <asp:Label ID="TbxMonthDuration" Width="80" CssClass="form-control" runat="server" />
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right">
                                        <span class="font-weight-bolder">
                                            ...
                                            <asp:Label ID="LblCompanyFullName" runat="server" />
                                        </span>
                                    </label>
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxCompanyFullName" runat="server" />
                                        </div>
                                    ...
                                    <label class="col-lg-3 col-form-label text-right">
                                        <span class="font-weight-bolder">
                                            <span class="text-dark-50 font-weight-bold"></span>
                                            <asp:Label ID="LblCompanyUrl" runat="server" />
                                        </span>
                                    </label>
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <a id="aWebsite" runat="server" class="text-primary font-weight-bolder">
                                                <asp:Label ID="TbxCompanyUrl" runat="server" />
                                            </a>
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label text-right">
                                        <span class="font-weight-bolder">
                                            <span class="text-dark-50 font-weight-bold"></span>
                                            <asp:Label ID="LblDivisionalName" runat="server" />
                                        </span>
                                    </label>
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxDivisionalName" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                    <label class="col-lg-3 col-form-label text-right">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxStreetAddress" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxCompanyCity" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                    <label class="col-lg-3 col-form-label text-right">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxCompanyCountry" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxPostalCode" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                    <label class="col-lg-3 col-form-label text-right">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxPhoneNumber" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxJobTitle" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                    <label class="col-lg-3 col-form-label text-right">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group mt-3">
                                            <asp:Label ID="TbxEmailAddress" runat="server" />
                                        </div>
                                        <span class="form-text text-muted"></span>
                                    </div>
                                </div>
