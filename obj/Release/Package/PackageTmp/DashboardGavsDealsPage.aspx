<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardGavsDealsPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardGavsDealsPage" %>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="tab_1_1" runat="server" role="tabpanel" aria-labelledby="kt_tab_pane_1_3">
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                            ...
                                            <asp:Repeater ID="RdgDealsPending" Visible="false" OnItemDataBound="RdgDealsPending_OnItemDataBound" runat="server">
                                                <ItemTemplate>
                                                    <tbody>
                                                        <tr>
                                                            <td style="">
                                                            ...
                                                            <td id="tdbClientEmail" runat="server" style="">
                                                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                                                    <div id="divDublicateFlag" runat="server" style="float:left;" visible="false">
                                                                        <img src="/assets/media/svg/icons/Communication/Flag.svg" alt="Dublicate flag" />
                                                                        <telerik:RadToolTip ID="RttDublicateInfo" TargetControlID="divDublicateFlag" Position="TopRight" runat="server" />
                                                                    </div>
                                                            ...
                                                            <td id="tdbActions" runat="server" style="width: 110px;">
                                                                <a id="aEdit" runat="server" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                    ...
                                    <div class="tab-pane fade" id="tab_1_2" visible="false" runat="server" role="tabpanel" aria-labelledby="kt_tab_pane_2_3">
                                        <!--begin::Search Form-->
                                        <div class="mb-7">
                                            <div class="row align-items-center">
                                                <div class="col-lg-9 col-xl-8">
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                            ...
                                            <asp:Repeater ID="RdgDealsOpen" Visible="false" OnItemDataBound="RdgDealsOpen_OnItemDataBound" runat="server">
                                                <ItemTemplate>
                                                    <tbody>
                                                        <tr>
                                                            <td style="">
                                    ...
                                    <div class="tab-pane fade" id="tab_1_3" visible="false" runat="server" role="tabpanel" aria-labelledby="kt_tab_pane_3_3">
                                        <!--begin::Search Form-->
                                        <div class="mb-7">
                                            <div class="row align-items-center">
                                                <div class="col-lg-9 col-xl-8">
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                            ...
                                            <asp:Repeater ID="RdgPastDeals" Visible="false" OnItemDataBound="RdgPastDeals_OnItemDataBound" runat="server">
                                                <ItemTemplate>
                                                    <tbody>
                                                        <tr>
                                                            <td style="">
