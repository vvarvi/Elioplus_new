<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardPartnerOnboardingPageNew.aspx.cs" Inherits="WdS.ElioPlus.DashboardPartnerOnboardingPageNew" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="d-flex flex-row">
                                ...
                                <div class="card-body px-5">
                                    ...
                                    <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                        ...
                                        <div class="navi-item my-2 mb-6" style="text-align: center;">
                                            <a id="BtnSendFile" onserverclick="aSendFile_ServerClick" class="btn btn-primary px-6 font-weight-bold flaticon2-telegram-logo" runat="server">Upload New Files
                                            </a>
                                        </div>
                                        <!--end:Item-->
                        ...
                        <div class="flex-row-fluid d-flex flex-column ml-lg-8">
                            ...
                            <div class="card card-custom card-stretch" style="margin-bottom: 25px; height: 75px;">                                
                                <!--begin::Info-->
            ...
            <ContentTemplate>
                <div role="document" class="modal-dialog">
                    <div class="modal-content" style="display: inline-table; width: 650px;">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <asp:Label ID="LblSelectReceiversAndUploadFiles" Text="Upload files for your partners" runat="server" />
                            </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <i aria-hidden="true" class="ki ki-close"></i>
                            </button>
