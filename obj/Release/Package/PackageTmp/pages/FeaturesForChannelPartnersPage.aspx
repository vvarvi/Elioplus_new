<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="FeaturesForChannelPartnersPage.aspx.cs" Inherits="WdS.ElioPlus.pages.FeaturesForChannelPartnersPage" %>
                ...
                <div class="grid-cols-1 lg:grid-cols-2 grid gap-30px">
                    <div class="row-start-2 lg:row-start-1 gap-20px lg:gap-30px flex flex-col justify-center">
                        <div class="text-center lg:text-left gap-10px lg:gap-15px flex flex-col">
                            <h1 class="text-2.5xl lg:text-5xl font-bold font-inter">Features for Channel Partners</h1>
                            <h2 class="text-2xl lg:text-3xl font-bold font-inter text-blue">The benefits of Elioplus channel partners.</h2>
                        </div>
                        <p class="text-base lg:text-body text-center lg:text-left">All our features are completely free for channel partners without limitations. On this page you can view all the perks that you have if you create an account with Elioplus as a channel partner.</p>
                        <div class="flex items-center gap-10px xl:gap-15px flex-col lg:flex-row">
                            <a class="btn large font-bold text-sm xl:text-base" href="/vendors-features"><span>VENDORS FEATURES</span><svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_75_23830)"><path d="M2.28634 0.643855L1.98948 0.938663C1.89677 1.03144 1.8457 1.15488 1.8457 1.28681C1.8457 1.41867 1.89677 1.54225 1.98948 1.63503L5.35258 4.99799L1.98575 8.36482C1.89304 8.45745 1.84204 8.58104 1.84204 8.7129C1.84204 8.84475 1.89304 8.96841 1.98575 9.06112L2.28078 9.356C2.47263 9.548 2.78515 9.548 2.977 9.356L7.00003 5.34738C7.09267 5.25475 7.15794 5.13131 7.15794 4.99828V4.99674C7.15794 4.86482 7.09259 4.74138 7.00003 4.64874L2.9879 0.643855C2.89527 0.551074 2.7681 0.500147 2.63624 0.5C2.50431 0.5 2.3789 0.551074 2.28634 0.643855Z" fill="#39B4EF" /></g><defs><clipPath id="clip0_75_23830"><rect width="9" height="9" fill="white" transform="matrix(0 -1 1 0 0 9.5)" /></clipPath>
                            </defs></svg>
                    ...
                    <div class="flex justify-center">
                        <img class="max-w-[300px] mdl:max-w-full" src="/assets_out/images/features/channel-partners/opener.svg" alt="The features and benefits of Elioplus for Channel Partners"></div>
                </div>
            </div>
                ...
                <div class="gap-80px lg:gap-160px flex flex-col">
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        ...
                        <div class="flex items-center justify-center">
                            <img class="max-w-[300px] mdl:max-w-full" src="/assets_out/images/features/channel-partners/signup.svg" alt="Sign up for free as a channel partner at Elioplus" loading="lazy"></div>
                    </div>
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        <div class="flex items-center justify-center">
                            <img class="max-w-[300px] mdl:max-w-full" src="/assets_out/images/features/channel-partners/partner.svg" alt="Partner with new vendors as a channel partner at Elioplus" loading="lazy"></div>
                        <div class="gap-20px lg:gap-30px flex flex-col justify-center">
                            <h3 class="text-2xl lg:text-3xl font-bold font-inter text-center lg:text-left">Partner with new vendors</h3>
                    ...
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        <div class="row-start-2 lg:row-start-1 gap-20px lg:gap-30px flex flex-col justify-center">
                            <h3 class="text-2xl lg:text-3xl font-bold font-inter text-center lg:text-left">Manage your vendors</h3>
                        ...
                        <div class="flex items-center justify-center">
                            <img class="max-w-[300px] mdl:max-w-full" src="/assets_out/images/features/channel-partners/manageVendors.svg" alt="Manage your vendors as a channel partner at Elioplus" loading="lazy"></div>
                    </div>
                    <div class="grid-cols-1 lg:grid-cols-2 text-img-row grid gap-30px">
                        <div class="flex items-center justify-center">
                            <img class="max-w-[300px] mdl:max-w-full" src="/assets_out/images/features/channel-partners/sales.svg" alt="Receive sales incentives as a channel partner at Elioplus" loading="lazy"></div>
                        <div class="gap-20px lg:gap-30px flex flex-col justify-center">
                            <h3 class="text-2xl lg:text-3xl font-bold font-inter text-center lg:text-left">Receive sales incentives</h3>
