<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="SearchForChannelPartnersByRegionCountryStateCityPage.aspx.cs" Inherits="WdS.ElioPlus.pages.SearchForChannelPartnersByRegionCountryStateCityPage" %>
            ...
            <div class="container">
                <div class="gap-40px lg:gap-60px flex flex-col justify-center items-center w-full">
                    <div class="gap-20px lg:gap-30px flex flex-col justify-center items-center w-full">
                        <div class="text-center gap-5px lg:gap-10px flex flex-col items-center w-full">
                            <div class="text-xs lg:text-base flex gap-5px items-center justify-center text-textGray font-medium">
                                ...
                                <a id="aBCrState" runat="server" class="transition-all duration-200 hover:text-blue"></a>
                        ...
                        <div class="flex justify-center">
                            <div class="flex gap-10px w-full lg:w-[760px] max-w-full pt-5px pr-5px pb-5px pl-15px bg-white shadow-card rounded-40px overflow-hidden" method="POST" action="SearchForChannelPartnersByRegionCountryStateCityPage.aspx">
                    ...
                    <div id="divCitiesArea" runat="server" class="gap-20px lg:gap-30px flex flex-col text-center items-center">
                        <h3 class="text-xl lg:text-2xl font-bold font-inter">Cities in state <span id='currentCountry'>
                    ...
                    <div id="divStatesArea" runat="server" class="gap-20px lg:gap-30px flex flex-col text-center items-center">
