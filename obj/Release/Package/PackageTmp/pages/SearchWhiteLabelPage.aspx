<%@ Page Title="" Language="C#" MasterPageFile="~/Elioplus.Master" AutoEventWireup="true" CodeBehind="SearchWhiteLabelPage.aspx.cs" Inherits="WdS.ElioPlus.pages.SearchWhiteLabelPage" %>

<asp:Content ID="HowItWorksHead" ContentPlaceHolderID="HeadContent" runat="server">
    <meta name="description" content="Browse thousands of different white label SaaS partner programs based on product category." />
    <meta name="keywords" content="white label partner programs, white label SaaS programs" />
</asp:Content>
                ...
                <div class="gap-40px lg:gap-60px flex flex-col justify-center items-center w-full">
                    <div class="gap-20px lg:gap-30px flex flex-col justify-center items-center w-full">
                        <div class="text-center gap-5px lg:gap-10px flex flex-col items-center w-full">
                            ...
                            <h1 class="text-2.5xl lg:text-5xl font-bold font-inter">White label partner programs</h1>
