<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DealsOpenGridControl.ascx.cs" Inherits="WdS.ElioPlus.Dashboard.Components.Grid.DealsOpenGridControl" %>
                    ...
                    <tr>
                        ...
                        <td style="">
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                <asp:Label ID="Label1" Text='<%# DataBinder.Eval(Container.DataItem, "partner_location")%>' runat="server" />
                            </span>
                        </td>
                        <td style="">
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
