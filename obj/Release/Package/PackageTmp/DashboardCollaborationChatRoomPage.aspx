<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardCollaborationChatRoomPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardCollaborationChatRoomPage" %>
...
<asp:Content ID="DashHomeMain" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-row">
                        <!--begin::Aside-->
                        <div class="flex-row-auto offcanvas-mobile w-350px w-xl-400px" id="kt_chat_aside" style="min-height: 600px;">
                            <!--begin::Card-->
                            <div class="card card-custom" style="min-height: 540px; margin-bottom: 20px;">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <!--begin:Search-->
                                    ...
                                    <!--begin:Users-->
                                    <div id="divTabConnections" runat="server" class="mt-7 scroll scroll-pull">
                                    ...
                                    <div id="divTabGroups" visible="false" runat="server" class="mt-7 scroll scroll-pull">
                                        ...
                                        <asp:Panel ID="PnlCreateRetailorGroups" Style="padding: 5px; text-align: center;" runat="server">
                                            <a data-target="#CreateRetailor" id="aCreateRetailor" data-toggle="modal" class="btn btn-primary" runat="server">
                                                <i id="iAddRetailor" class="ion-plus-round mr-5" runat="server"></i>
                                                <asp:Label ID="LblAddGroup" Text="Create new group" runat="server" />
                                            </a>
                                        </asp:Panel>
                                        <telerik:RadGrid ID="RdgRetailorsGroups" Style="margin: auto; position: relative;" AllowPaging="false" AllowSorting="false" HeaderStyle-BackColor="#39b4ef" ShowHeader="false" HeaderStyle-ForeColor="#ffffff" PageSize="10" Width="100%" CssClass="rgdd" OnDetailTableDataBind="RdgRetailorsGroups_DetailTableDataBind" OnPreRender="RdgRetailorsGroups_PreRender" OnItemDataBound="RdgRetailorsGroups_OnItemDataBound" AutoGenerateColumns="false" runat="server">
                                            <MasterTableView Width="100%" DataKeyNames="id" Name="Parent" AllowMultiColumnSorting="true">
                                                ...
                                                <DetailTables>
                                                    <telerik:GridTableView DataKeyNames="id" Name="UsersGroupRetailors" Width="100%">
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn Display="false" DataField="group_retailor_id" UniqueName="group_retailor_id" />
                                                            ...
                                                            <telerik:GridBoundColumn DataField="country" Display="false" UniqueName="country" />
                                                            <telerik:GridBoundColumn Display="false" DataField="region" UniqueName="region" />
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Logo" HeaderStyle-Width="20">
                                                                <ItemTemplate>
                                                                    <ul class="chat-list m-0 media-list">
                                                                        <li class="media">
                                                                            <a id="aCompanyLogo" href="javascript:;" runat="server">
                                                                                <div class="media-left avatar">
                                                                                    <asp:ImageButton ID="ImgCompanyLogo" Width="34" Height="34" class="media-object img-circle" runat="server" />
                                                                                </div>
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                            ...
                                                            <telerik:GridBoundColumn Display="false" DataField="company_name" UniqueName="company_name" />
                                                            <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-Width="120">
                                                                <ItemTemplate>
                                                                    <ul class="chat-list m-0 media-list">
                                                                        <li class="media">
                                                            ...
                                                            <telerik:GridBoundColumn Display="false" HeaderText="Country" HeaderStyle-Width="50" DataField="country" UniqueName="country" />
                                                        </Columns>
                                                ...
                                                <Columns>
                                                    <telerik:GridTemplateColumn HeaderStyle-Width="10" DataField="select" UniqueName="select">
                                                        <ItemTemplate>
                                                            <asp:CheckBox AutoPostBack="true" ID="CbxSelectGroupUsers" OnCheckedChanged="CbxSelectGroupUsers_OnCheckedChanged" runat="server" />
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridBoundColumn Display="false" DataField="id" UniqueName="id" />
                                                    <telerik:GridBoundColumn Display="false" DataField="user_id" UniqueName="user_id" />
                                                    <telerik:GridBoundColumn DataField="collaboration_group_name" UniqueName="collaboration_group_name" />
                                                    <telerik:GridBoundColumn Display="false" DataField="group_msgs_count" UniqueName="group_msgs_count" />
                                                    <telerik:GridTemplateColumn HeaderStyle-Width="5">
                                                        <ItemTemplate>
                                                            <span id="spanGroupMessagesCount" class="badge bg-danger" style="margin-top: 0px;" title="New unread group message" visible="false" runat="server">
                                                                <asp:Label ID="LblGroupMessagesCount" runat="server" />
                                                            </span>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridBoundColumn Display="false" DataField="date_created" UniqueName="date_created" />
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderStyle-Width="5">
                                                        <ItemTemplate>                                                            
                                                            <a href="#" id="aDeleteGroup" visible="false" title="Delete your group" runat="server">
                                                                <i class="glyphicon glyphicon-edit"></i>
                                                            </a>
                                                            <asp:ImageButton ID="ImgBtnDeleteGroup" OnClick="ImgBtnDeleteGroup_OnClick" Visible="true" ImageUrl="~/images/icons/small/delete.png" runat="server" />
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                    <telerik:GridTemplateColumn HeaderStyle-Width="5">
                                                        <ItemTemplate>
                                                            <a href="#EditRetailor" id="aEdit" visible="false" title="Edit your group" onserverclick="BtnEdit_OnClick" runat="server">
                                                                <i class="glyphicon glyphicon-edit"></i>
                                                            </a>
                                                            <asp:ImageButton ID="ImgBtnEdit" Visible="false" ImageUrl="~/images/icons/edit_1.png" runat="server" />
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                </Columns>
                                            </MasterTableView>
                                ...
                                <div class="card-footer align-items-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-5">
                                        <div class="mr-3">
                                            ...
                                            <a id="aLibraryFile" title="Select file from my library" runat="server" onserverclick="aLibraryFile_ServerClick" class="btn btn-clean btn-icon btn-md">
                                        ...
                                        <div>
                                            ...
                                            <asp:Button ID="ImgBtnSendMsg" OnClick="ImgBtnSendMsg_OnClick" Text="Send" CssClass="btn btn-primary btn-md text-uppercase font-weight-bold chat-send py-2 px-6" runat="server" />
                                        </div>
                                    </div>
                                    <!--begin::Compose-->
                                        ...
                                        <div class="form-group" style="">
                                            <div class="row">
                                                <div class="col-sm-6" style="">
                                                    <div class="form-group">
                                                        <asp:DropDownList ID="DdlCategory" Width="250" Height="30" runat="server" />
                                                    </div>
                                                    <div class="form-group">
    ...
    <div id="CreateRetailor" class="modal fade" tabindex="-1">
    ...
    <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function ClosePopUp() {
                $('#CreateRetailor').modal('hide');
            }

            function OpenPopUp() {
                $('#CreateRetailor').modal('show');
            }
