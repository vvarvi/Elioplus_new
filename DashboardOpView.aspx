<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="DashboardOpView.aspx.cs" Inherits="WdS.ElioPlus.DashboardOpView" %>
                                ...
                                <div class="portlet-title" style="padding:0px;">                            
                                    ...
                                    <div class="caption" style="width:100%;">                                        
                                        <%--<div class="classname" style="max-width:240px">
                                            <asp:DropDownList AutoPostBack="true" Visible="false" ID="DdlContactCounts" OnTextChanged="DdlContactCounts_OnTextChanged" runat="server">                                                   
                                            </asp:DropDownList>--%>
                                            <telerik:RadGrid ID="RdgContacts" AllowPaging="true" Width="240" PageSize="10" CssClass="rgdd" ShowHeader="false" PagerStyle-Position="Bottom" HeaderStyle-ForeColor="#ffffff" OnPageIndexChanged="RdgContacts_OnPageIndexChanged" OnNeedDataSource="RdgContacts_OnNeedDataSource" OnItemDataBound="RdgContacts_OnItemDataBound" AutoGenerateColumns="false" runat="server">
                                                <MasterTableView>
                                                    <NoRecordsTemplate>
                                                    ...
                                                    <Columns> 
                                                        ...
                                                        <telerik:GridTemplateColumn DataField="actions" UniqueName="actions">
                                                            <ItemTemplate>
                                                                <telerik:RadListBox ID="RlbContacts" RenderMode="Lightweight" Height="150px" Width="100%" runat="server">
                                                                    <ItemTemplate>                                                
                                                                        <div style="float:right">                                                    
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="portlet light portlet-fit bordered" style="border: 0px solid #e7ecf1 !important;">
                                <div class="portlet-title" style="padding:0px;">                            
                                    ...
                                    <div class="caption" style="width:100%;">
                                        <%--<div class="classname" style="max-width:240px">                                            
                                            <asp:DropDownList AutoPostBack="true" Visible="false" ID="DdlMeetingCount" OnTextChanged="DdlMeetingCount_OnTextChanged" runat="server">                                                    
                                            </asp:DropDownList>--%>
                                            <telerik:RadGrid ID="RdgMeeting" AllowPaging="true" PageSize="10" Width="240" CssClass="rgdd" ShowHeader="false" PagerStyle-Position="Bottom" HeaderStyle-ForeColor="#ffffff" OnPageIndexChanged="RdgMeeting_OnPageIndexChanged" OnNeedDataSource="RdgMeeting_OnNeedDataSource" OnItemDataBound="RdgMeeting_OnItemDataBound" AutoGenerateColumns="false" runat="server">
                                                <MasterTableView>
                                                    <NoRecordsTemplate>
                                                        <div class="emptyGridHolder">
                                                            <asp:Literal ID="LtlNoDataFound" runat="server" />
                                                    ...
                                                    <Columns> 
                                                        ...
                                                        <telerik:GridTemplateColumn DataField="actions" UniqueName="actions">
                                                            <ItemTemplate>
                                                                <telerik:RadListBox ID="RlbMeeting" RenderMode="Lightweight" Height="150px" Width="100%" runat="server">
                                                                    <ItemTemplate>
                                                                        <div style="float:right">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="portlet light portlet-fit bordered" style="border: 0px solid #e7ecf1 !important;">
                                <div class="portlet-title" style="padding:0px;">                            
                                    ...
                                    <div class="caption" style="width:100%;">
                                        <%--<div class="classname" style="max-width:240px">
                                            <asp:DropDownList AutoPostBack="true" Visible="false" ID="DdlProposalCount" OnTextChanged="DdlProposalCount_OnTextChanged" runat="server">                                                   
                                            </asp:DropDownList>--%>
                                            <telerik:RadGrid ID="RdgProposal" AllowPaging="true" Width="240" PageSize="10" CssClass="rgdd" ShowHeader="false" PagerStyle-Position="Bottom" HeaderStyle-ForeColor="#ffffff" OnPageIndexChanged="RdgProposal_OnPageIndexChanged" OnNeedDataSource="RdgProposal_OnNeedDataSource" OnItemDataBound="RdgProposal_OnItemDataBound" AutoGenerateColumns="false" runat="server">
                                                <MasterTableView>
                                                    <NoRecordsTemplate>
                                                        <div class="emptyGridHolder">
                                                            <asp:Literal ID="LtlNoDataFound" runat="server" />
                                                    ...
                                                    <Columns> 
                                                        ...
                                                        <telerik:GridTemplateColumn DataField="actions" UniqueName="actions">
                                                            <ItemTemplate>
                                                                <telerik:RadListBox ID="RlbProposal" RenderMode="Lightweight" Height="150px" Width="230px" runat="server">
                                                                    <ItemTemplate>
                                                                        <div style="float:right">
                                                                            <a id="aMoveLeft" onserverclick="BtnConfirm_OnClick" runat="server">
                                                                                <i id="iMoveLeft" class="fa fa-arrow-left" runat="server"></i>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">                        
                            <div class="portlet light portlet-fit bordered" style="border: 0px solid #e7ecf1 !important;">
                                <div class="portlet-title" style="padding:0px;">                            
                                    ...
                                    <div class="caption" style="width:100%;">
                                        <%--<div class="classname" style="max-width:240px">     
                                            <asp:DropDownList AutoPostBack="true" Visible="false" ID="DdlClosedCount" OnTextChanged="DdlClosedCount_OnTextChanged" runat="server">                                                   
                                            </asp:DropDownList>--%>
                                            <telerik:RadGrid ID="RdgClosed" AllowPaging="true" PageSize="10" Width="240" CssClass="rgdd" ShowHeader="false" PagerStyle-Position="Bottom" HeaderStyle-ForeColor="#ffffff" OnPageIndexChanged="RdgClosed_OnPageIndexChanged" OnNeedDataSource="RdgClosed_OnNeedDataSource" OnItemDataBound="RdgClosed_OnItemDataBound" AutoGenerateColumns="false" runat="server">
                                                <MasterTableView>
                                                    <NoRecordsTemplate>
                                                        <div class="emptyGridHolder">
                                                            <asp:Literal ID="LtlNoDataFound" runat="server" />
                                                    ...
                                                    <Columns> 
                                                        ...
                                                        <telerik:GridTemplateColumn DataField="actions" UniqueName="actions">
                                                            <ItemTemplate>
                                                                <telerik:RadListBox ID="RlbClosed" RenderMode="Lightweight" Height="190px" Width="100%" runat="server">
                                                                    <ItemTemplate>
                                                                        <div style="float:right">
                                                                            <a id="aMoveLeft" onserverclick="BtnConfirm_OnClick" runat="server">
                                                                                <i id="iMoveLeft" class="fa fa-arrow-left" runat="server"></i>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">                            
                            ...
                            <asp:Button ID="BtnBack" Text="Back" OnClick="BtnBack_OnClick" CssClass="btn dark btn-outline" runat="server" />
