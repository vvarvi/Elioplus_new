...
{
    public partial class DashboardPDPartnersRequestsPage : System.Web.UI.Page
    {
        ...
        private void FixPage()
        {
            ...
            LblSuccessMsg.Text = "";
            LblTitle2Confirmed.Text = "Pending Invitations/Requests";
        ...
        private void ShowPopUpModalWithText(string title, string content)
        {
            ...
            GlobalMethods.ShowMessageControlDA(UcMessageSuccessSend, content, MessageTypes.Success, true, true, true, true, false);
                    ...
                    if (company != null)
                    {
                        ...
                        if (vSession.User.CompanyType == Types.Vendors.ToString())
                        {
                            ...
                            else if (item["invitation_status"].Text == CollaborateInvitationStatus.Pending.ToString())
                            {
                                ...
                                lblStatus.CssClass = "label label-lg label-light-warning label-inline";
                                //cbxSelectUser.Enabled = false;
                                //aMoreDetails.Visible = false;
                            }
                        }
                        else
                        {
                            ...
                            if (item["invitation_status"].Text == CollaborateInvitationStatus.Rejected.ToString())
                            {
                                ...
                                lblStatus.Text = CollaborateInvitationStatus.Rejected.ToString();
                                lblStatus.CssClass = "label label-lg label-danger label-inline";
                                //aMoreDetails.Visible = false;
                            }
                            else if (item["invitation_status"].Text == CollaborateInvitationStatus.Pending.ToString())
                            {
                            ...
                            else if (item["invitation_status"].Text == CollaborateInvitationStatus.Confirmed.ToString())
                            {
                                ...
                                lblStatus.CssClass = "label label-lg label-success label-inline";
        ...
        protected void RdgReceivedInvitations_OnNeedDataSource(object sender, EventArgs args)
        {
            try
            {
                ...
                if (vSession.User != null)
                {
                    ...
                    if (partners.Count > 0)
                    {
                        spanPendingRequests.Visible = true;
                        LblPendingRequests.Text = partners.Count.ToString();
                        LblPendingRequests.ToolTip = (vSession.User.CompanyType == Types.Vendors.ToString()) ? "Pending requests" : "Pending invitations";
                        ...
                        #region Select the tab

                        //if (vSession.User.CompanyType == Types.Vendors.ToString())
                        //{
                        //    List<ElioCollaborationVendorsResellersIJUsers> partnerInvitations = SqlCollaboration.GetVendorCollaborationInvitationsToChannelPartners(vSession.User.Id, RtbxCompanyNameEmailPending.Text.Trim(), CollaborateInvitationStatus.Pending.ToString(), (DdlCountriesPending.SelectedItem.Value != "0") ? DdlCountriesPending.SelectedItem.Text : "", session);

                        //    if (partnerInvitations.Count == 0)
                        //    {
                        //        aReceiveInvitations.Attributes["class"] = "nav-link active";
                        //        tab_1_2.Attributes["class"] = "tab-pane fade show active";
                        //        tab_1_2.Visible = true;
                    ...
                    else
                    {
                        ...
                        spanPendingRequests.Visible = false;
        ...
        protected void DdlCountriesPending_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (vSession.User != null)
        ...
        protected void DdlCountriesPendingRequests_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (vSession.User != null)
        ...
        protected void DdlInvitationStatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (vSession.User != null)
        ...
        protected void aSendInvitations_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ShowTab(1);
        ...
        protected void aReceiveInvitations_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ShowTab(2);
