<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="DashboardPersonProfile.aspx.cs" Inherits="WdS.ElioPlus.DashboardPersonProfile" %>
...
<asp:Content ID="DashHomeMain" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="list-unstyled profile-nav">
                                <li>
                                    <img id="imgCompanyLogo" class="img-responsive pic-bordered" alt="" runat="server" />
                                        ...
                                        <div class="form-group">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="file input" /> </div>
    ...
    <div id="divHomeInfo" runat="server" visible="false" class="m-heading-1 border-green m-bordered">
        <asp:Label ID="LblHomeContent" runat="server" />
    </div>
    ...
    <script type="text/javascript" src="/assets/tutorial/intro.js"></script>      
</asp:Content>
