<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardOpportunitiesViewTasksPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardOpportunitiesViewTasksPage" %>
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card-body">
                                        <!--begin::Button-->
                                        <a id="aAddTask" role="button" onserverclick="aAddTask_ServerClick" class="btn btn-success font-weight-bold" runat="server">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <controls:MessageControl ID="UcMessageInfo" Message="Create and manage your tasks for this opportunity. Click 'Add Task' above to create a new one or manage the existing ones below." IsLightColor="true" MessageType="Info" runat="server" />
                                            </div>
