...
{
    public partial class DashboardTrainingOverviewPage : System.Web.UI.Page
    {
        ...
        private void GetCategoriesFilesCountNotificationsByCategoryId(RepeaterItem item, int categoryId)
        {
            ...
            {
                strQuery += @" and user_id = " + vSession.User.Id + " ";
            }
            else
            {
                if (DrpVendors.SelectedValue != "0")
                {
                    strQuery += @" user_id = " + Convert.ToInt32(DrpVendors.SelectedValue) + " ";
                }
            }
        ...
        private void SetLinks()
        {
            ...
            BtnSendFile.HRef = ControlLoader.Dashboard(vSession.User, "partner-training-add-new");
        }
        ...
        private void FixTabMenu()
        {
            ...
            if (vSession.User.CompanyType == Types.Vendors.ToString())
            {
                table = Sql.GetElioUserTrainingCategoriesTbl(vSession.User.Id, session);
            }
            else
            {
                if (DrpVendors.SelectedValue != "")
                    table = Sql.GetElioUserTrainingCategoriesTbl(Convert.ToInt32(DrpVendors.SelectedValue), session);
            }
        ...
        private bool FileExistsNew(DataTable table, string fileName)
        {
            if (table != null && table.Rows.Count > 0)
            {
                ...
                {
                    if (row["overview_image_name"].ToString() == fileName)
                    {
                        return true;
                    }
                }
        ...
        private bool FileExistsNew1(DataTable table, string fileName)
        {
            if (table != null && table.Rows.Count > 0)
            {
                foreach (DataRow row in table.Rows)
                {
                    if (row["overview_image_name1"].ToString() == fileName)
                    {
                        return true;
                    }
                }
        ...
        private bool FileExistsNew2(DataTable table, string fileName)
        {
            if (table != null && table.Rows.Count > 0)
            {
                foreach (DataRow row in table.Rows)
                {
                    if (row["overview_image_name2"].ToString() == fileName)
                    {
                        return true;
                    }
                }
        ...
        private bool FileExistsNew3(DataTable table, string fileName)
        {
            if (table != null && table.Rows.Count > 0)
            {
                foreach (DataRow row in table.Rows)
                {
                    if (row["overview_image_name3"].ToString() == fileName)
                    {
                        return true;
                    }
                }
        ...
        private bool FileExistsNew4(DataTable table, string fileName)
        {
            if (table != null && table.Rows.Count > 0)
            {
                foreach (DataRow row in table.Rows)
                {
                    if (row["overview_image_name4"].ToString() == fileName)
                    {
                        return true;
                    }
                }
        ...
        private void DeleteFile(int id, int fileTypeId, int categoryId, string fileName)
        {
            if (fileTypeId > 0 && id > 0 && fileName != "" && categoryId > -1)
            {
                ...
                GlobalMethods.ShowMessageControlDA(UcConfirmationMessageControl, "Are you sure you want to delete this course from your category?", MessageTypes.Warning, true, true, true, true, false);
                ...
                if (row != null)
                {
                    ...
                    if (div1.Visible)
                    {
                        ...
                        if (liDeletePreviewImg1 != null)
                            liDeletePreviewImg1.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && !string.IsNullOrEmpty(row["overview_image_path1"].ToString());
                        ...
                        if (liUploadPreviewImg1 != null)
                            liUploadPreviewImg1.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && string.IsNullOrEmpty(row["overview_image_path1"].ToString());

                        Label lbl1 = (Label)ControlFinder.FindControlRecursive(item, "Lbl1");

                        if (!string.IsNullOrEmpty(row["overview_image_name1"].ToString()))
                        {
                            if (row["overview_image_name1"].ToString().Length > 25)
                            {
                                lbl1.Text = row["overview_image_name1"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl1.Text = row["overview_image_name1"].ToString();
                            }
                        }
                        else
                        {
                            if (row["overview_text1"].ToString().Length > 25)
                            {
                                lbl1.Text = row["overview_text1"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl1.Text = row["overview_text1"].ToString();
                            }
                        }
                    }
                    if (div2.Visible)
                    {
                        ...
                        if (liDeletePreviewImg2 != null)
                            liDeletePreviewImg2.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && !string.IsNullOrEmpty(row["overview_image_path2"].ToString());
                        ...
                        if (liUploadPreviewImg2 != null)
                            liUploadPreviewImg2.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && string.IsNullOrEmpty(row["overview_image_path2"].ToString());

                        Label lbl2 = (Label)ControlFinder.FindControlRecursive(item, "Lbl2");

                        if (!string.IsNullOrEmpty(row["overview_image_name2"].ToString()))
                        {
                            if (row["overview_image_name2"].ToString().Length > 25)
                            {
                                lbl2.Text = row["overview_image_name2"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl2.Text = row["overview_image_name2"].ToString();
                            }
                        }
                        else
                        {
                            if (row["overview_text2"].ToString().Length > 25)
                            {
                                lbl2.Text = row["overview_text2"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl2.Text = row["overview_text2"].ToString();
                            }
                        }
                    }
                    if (div3.Visible)
                    {
                        ...
                        if (liDeletePreviewImg3 != null)
                            liDeletePreviewImg3.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && !string.IsNullOrEmpty(row["overview_image_path3"].ToString());
                        ...
                        if (liUploadPreviewImg3 != null)
                            liUploadPreviewImg3.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && string.IsNullOrEmpty(row["overview_image_path3"].ToString());

                        Label lbl3 = (Label)ControlFinder.FindControlRecursive(item, "Lbl3");

                        if (!string.IsNullOrEmpty(row["overview_image_name3"].ToString()))
                        {
                            if (row["overview_image_name3"].ToString().Length > 25)
                            {
                                lbl3.Text = row["overview_image_name3"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl3.Text = row["overview_image_name3"].ToString();
                            }
                        }
                        else
                        {
                            if (row["overview_text3"].ToString().Length > 25)
                            {
                                lbl3.Text = row["overview_text3"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl3.Text = row["overview_text3"].ToString();
                            }
                        }
                    }
                    if (div4.Visible)
                    {
                        ...
                        if (liDeletePreviewImg4 != null)
                            liDeletePreviewImg4.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && !string.IsNullOrEmpty(row["overview_image_path4"].ToString());
                        ...
                        if (liUploadPreviewImg4 != null)
                            liUploadPreviewImg4.Visible = vSession.User.CompanyType == Types.Vendors.ToString() && string.IsNullOrEmpty(row["overview_image_path4"].ToString());

                        Label lbl4 = (Label)ControlFinder.FindControlRecursive(item, "Lbl4");

                        if (!string.IsNullOrEmpty(row["overview_image_name4"].ToString()))
                        {
                            if (row["overview_image_name4"].ToString().Length > 25)
                            {
                                lbl4.Text = row["overview_image_name4"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl4.Text = row["overview_image_name4"].ToString();
                            }
                        }
                        else
                        {
                            if (row["overview_text4"].ToString().Length > 25)
                            {
                                lbl4.Text = row["overview_text4"].ToString().Substring(0, 25) + "...";
                            }
                            else
                            {
                                lbl4.Text = row["overview_text4"].ToString();
                            }
                        }
                    }
                }
                ...
                if (vSession.User != null)
                {
                    ...
                    if (userId > -1)
                    {
                        ...
                        if (vSession.User.CompanyType == Types.Vendors.ToString())
                        {
                            if (categoryID > 0)
                            {
                                files = Sql.GetElioUserTrainingCategoryCourses(userId, categoryID, session);
                            }
                            else
                            {
                                files = Sql.GetElioUserTrainingCategoryCoursesAll(userId, session);
                            }
                        }
                        else
                        {
                            if (categoryID > 0)
                            {
                                files = Sql.GetElioPartnerTrainingCategoryCourses(userId, vSession.User.Id, categoryID, session);
                            }
                            else
                            {
        ...
        protected void aAdd_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (vSession.User != null)
                {
                    ...
                    {
                        bool existCategoryDescription = Sql.ExistUserTrainingCategory(vSession.User.Id, TbxAddNewCategory.Text.Trim(), session);
                        ...
                        else
                        {
                            ...
                            ElioUsersTrainingCategories category = new ElioUsersTrainingCategories();
                            ...
                            else
                            {
                                if (tbxEditCategory.Text != "")
                                {
                                    if (lblDescription.Text != tbxEditCategory.Text)
                                    {
                                        ...
                                        bool success = Sql.UpdateUserTrainingCategoryDescription(vSession.User.Id, Convert.ToInt32(hdnId.Value), tbxEditCategory.Text.Trim(), session);
                                        if (!success)
                                        {
                                            //GlobalMethods.ShowMessageAlertControlDA(UcMessageAlert, "Sorry, this category description already exists for you! Please try different description", MessageTypes.Error, true, true, true, true, false);
                                        ...
                                        bool successUpdateTransfer = GlobalDBMethods.UpdateUserTrainingPathDirectoryAndMoveFiles(Server, vSession.User.Id, Convert.ToInt32(hdnId.Value), lblDescription.Text, tbxEditCategory.Text, session);
                                        if (!successUpdateTransfer)
                                        {
                                            Logger.DetailedError(Request.Url.ToString(), "DashboardTrainingOverviewPage.cs --> aEdit_ServerClick --> ERROR", string.Format("category description from {0} to {1} could not be updated in files path in DB for user {2} and category ID {3}", lblDescription.Text, tbxEditCategory.Text, vSession.User.Id, hdnId.Value));
                                        }
        ...
        protected void aAddChpt1_ServerClick(object sender, EventArgs e)
        {
            try
            {
                LibraryFileId = -1;
                ...
                if (imgBtn != null)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        System.Web.UI.ScriptManager.RegisterStartupScript(this, GetType(), "Open Modal Popup", "OpenAddChapterPopUp();", true);
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void aAddChpt2_ServerClick(object sender, EventArgs e)
        {
            try
            {
                LibraryFileId = -1;
        ...
        protected void aAddChpt3_ServerClick(object sender, EventArgs e)
        {
            try
            {
                LibraryFileId = -1;
        ...
        protected void aAddChpt4_ServerClick(object sender, EventArgs e)
        {
            try
            {
                LibraryFileId = -1;
        ...
        protected void aAddChptr_ServerClick(object sender, EventArgs e)
        {
