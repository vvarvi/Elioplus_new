...
{
    public partial class ViewInfoLogFiles : System.Web.UI.UserControl
    {
        private ElioSession vSession = new ElioSession();
        DBSession session = new DBSession();

        private static string logFilePath = System.Configuration.ConfigurationManager.AppSettings["LogInfoPath"];
        ...
        protected void ViewLogs_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    aViewLogFiles.HRef = aViewLogFilesText.HRef = System.Configuration.ConfigurationManager.AppSettings["ViewInfoLogFilesPath"] + "/" + item["fileName"].Text;
                    ...
                    hpLnkBtnPreViewLogFiles.NavigateUrl = System.Configuration.ConfigurationManager.AppSettings["ViewInfoLogFilesPath"] + "/" + item["fileName"].Text;
                    ...
                    hpLnkPreViewLogFiles.NavigateUrl = System.Configuration.ConfigurationManager.AppSettings["ViewInfoLogFilesPath"] + "/" + item["fileName"].Text;
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (vSession.User != null)
                {
                    ...
                    else
                    {
                        ...
                        string alert = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("content", "dashboard", "message", "14")).Text;
