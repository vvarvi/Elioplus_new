...
{
    public partial class ViewLogFiles : System.Web.UI.UserControl
    {
        ...
        protected void ViewLogs_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    aViewLogFiles.HRef = aViewLogFilesText.HRef = System.Configuration.ConfigurationManager.AppSettings["ViewLogFilesPath"] + "/" + item["fileName"].Text;
                    ...
                    //{
                    //    aViewLogFiles.HRef = aViewLogFilesText.HRef = "https://elioplus.com/Logs/" + item["fileName"].Text;
                    //}
                    ...
                    url = url + HttpContext.Current.Request.Url.Authority + "/Logs/" + item["fileName"].Text;
