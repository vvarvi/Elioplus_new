<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DADeleteOpportunityConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DADeleteOpportunityConfirmationMessageAlert" %>
                    ...
                    <form class="form-horizontal col-sm-12">
                        <div id="divInfo" runat="server" style="width: 100%;" class="alert alert-custom alert-light-info fade show">
                            ...
                            <div class="alert-text">
                                <strong>
                                    <asp:Label ID="LblMessage" Text="You are going to delete this contact" runat="server" /><br />
                                    <br />
