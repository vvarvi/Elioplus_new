<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DAMessageControl2Msgs.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DAMessageControl2Msgs" %>

<div id="PnlMessage" runat="server" class="alert alert-custom alert-primary" role="alert" style="margin-top: 30px;text-align: center; width: 100%;">
