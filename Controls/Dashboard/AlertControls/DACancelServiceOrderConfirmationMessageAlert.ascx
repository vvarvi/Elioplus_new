<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DACancelServiceOrderConfirmationMessageAlert.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.AlertControls.DACancelServiceOrderConfirmationMessageAlert" %>
