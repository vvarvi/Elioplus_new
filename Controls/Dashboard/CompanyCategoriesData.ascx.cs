...
{
    public partial class CompanyCategoriesData : System.Web.UI.UserControl
    {
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    try
                    {
                        ...
                        hasSeslectedItem = GlobalDBMethods.FixUserCategoriesByCheckBoxList(cbxIndustryList, Category.Industry, vSession.User.Id, false, session);
                        if (!hasSeslectedItem)
                        {
                            //error      
                        ...
                        hasSeslectedItem = GlobalDBMethods.FixUserCategoriesByCheckBoxList(cbxPartnerList, Category.Partner, vSession.User.Id, false, session);
                        if (!hasSeslectedItem)
                        {
                            //error
                        ...
                        hasSeslectedItem = GlobalDBMethods.FixUserCategoriesByCheckBoxList(cbxMarketList, Category.Market, vSession.User.Id, false, session);
                        if (!hasSeslectedItem)
                        {
                            //error
                        ...
                        hasSeslectedItem = GlobalDBMethods.FixUserCategoriesByCheckBoxList(cbxApiList, Category.Api, vSession.User.Id, false, session);
                        if (!hasSeslectedItem)
                        {
                            //error
        ...
        private void LoadCompanyData()
        {
            ...
            //PnlSubIndustry.Visible = (vSession.User.CompanyType == Types.Developers.ToString()) ? false : true;
            //if (PnlSubIndustry.Visible)
            //{
            #region Sub Industries
            ...
            //    count = 0;
            //    List<ElioSubIndustriesGroupItems> securityBackupGroup = Sql.GetSubIndustriesGroupItemsByIndustryGroupId(Convert.ToInt32(SubIndustryGroup.SecurityBackup), session);
            ...
            //int count = 0;
            //List<ElioSubIndustries> allSubIndustries = Sql.GetSubIndustries(session);
            //foreach (ElioSubIndustries subIndustry in allSubIndustries)
            //{
            //    ListItem item = new ListItem();

            //    item.Selected = Sql.ExistUserSubIndustry(vSession.User.Id, subIndustry.Id, session);
            //    //item.Enabled = (item.Selected) ? false : true;
            //    if (count <= 18)
            //    {
            //        item.Text = subIndustry.SubIndustryDescription;
            //        item.Value = subIndustry.Id.ToString();

            //        cbSub1.Items.Add(item);
            //        count++;
            //    }
            //    else if (count > 18 && count <= 37)
            //    {
            //        item.Text = subIndustry.SubIndustryDescription;
            //        item.Value = subIndustry.Id.ToString();
        ...
        {
            Label2.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("global", "", "label", "29")).Text;
            
            Label37.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("global", "", "label", "3")).Text;
            Label3.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("global", "", "label", "52")).Text;
            Label1.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("global", "", "label", "4")).Text;
            Label26.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("global", "", "label", "5")).Text;
            Label29.Text = Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("global", "", "label", "6")).Text;
