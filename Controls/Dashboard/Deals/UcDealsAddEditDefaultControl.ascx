<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcDealsAddEditDefaultControl.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.Deals.UcDealsAddEditDefaultControl" %>
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <div class="input-group">
                            <asp:DropDownList ID="DdlDealResult" Width="195" Height="36" runat="server">
                            </asp:DropDownList>
                            <div class="input-group-append"><span class="input-group-text"><i class="la la-user"></i></span></div>
                        </div>
                        <span class="form-text text-muted"></span>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-1">
                        <div class="input-group">
                            <asp:TextBox ID="TbxAmount" placeholder="Deal's Amount" TextMode="Number" CssClass="form-control" MaxLength="7" runat="server"></asp:TextBox>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                    <div id="divCurrencyArea" runat="server" class="col-lg-2">
                        <div class="input-group">
