<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcDealsViewDefaultControl.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.Deals.UcDealsViewDefaultControl" %>
