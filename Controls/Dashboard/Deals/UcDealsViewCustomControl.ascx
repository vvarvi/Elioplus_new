<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcDealsViewCustomControl.ascx.cs" Inherits="WdS.ElioPlus.Controls.Dashboard.Deals.UcDealsViewCustomControl" %>
