...
{
    public partial class UcDealsCustomControl : System.Web.UI.UserControl
    {
        ...
        public void BindPending()
        {
            try
            {
                ...
                else
                {
                    ...
                    GlobalMethods.ShowMessageControl(UcPendingMessage, "There are no Deals", MessageTypes.Info, true, true, false, false, false);
        ...
        public void BindPast()
        {
            try
            {
                ...
                else
                {
                    ...
                    GlobalMethods.ShowMessageControl(UcPastMessage, "There are no Deals", MessageTypes.Info, true, true, false, false, false);
        ...
        public void BindOpen()
        {
            try
            {
                ...
                else
                {
                    ...
                    GlobalMethods.ShowMessageControl(UcOpenMessage, "There are no Deals", MessageTypes.Info, true, true, false, false, false);
            ...
            try
            {
                ...
                if (vSession.User != null)
                {
                    ...
                    if (deal != null)
                    {
                        ...
                        {
                            BindPending();
                            GlobalMethods.ShowMessageControl(UcPendingMessage, "Deal was deleted successfully.", MessageTypes.Success, true, true, true, true, false);
                        }
                        else if (tab_1_2.Visible)
                        {
                            BindOpen();
                            GlobalMethods.ShowMessageControl(UcOpenMessage, "Deal was deleted successfully.", MessageTypes.Success, true, true, true, true, false);
                        }
                        else
                        {
                            BindPast();
                            GlobalMethods.ShowMessageControl(UcPastMessage, "Deal was deleted successfully.", MessageTypes.Success, true, true, true, true, false);
                        }
        ...
        protected void BtnAddNewDeal_Click(object sender, EventArgs e)
        {
            try
            {
                if (vSession.User != null)
                {
                    ...
                    {
                        sessionId = GlobalDBMethods.FixUrlByUserRole(vSession.User.Id, Convert.ToInt32(DrpPartners.SelectedItem.Value), session);
