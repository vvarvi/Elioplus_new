...
{
    public partial class FullRegistration : System.Web.UI.UserControl
    {
        ...
        private void PreLoadCompanyData()
        {
            if (vSession.User != null)
            {
                if (vSession.User.Email != "" && vSession.User.AccountStatus == (int)AccountStatus.NotCompleted)
                {
                    ...
                    //    vSession.User.Country = "";
                    //}

                    //tbxAddress.Text = vSession.User.Address;
                    //vSession.User.Address = "";
                    //tbxCompanyPhone.Text = vSession.User.Phone;
                    //vSession.User.Phone = "";
                    //tbxDescription.Text = vSession.User.Description;
                    //vSession.User.Description = "";
                    //tbxOverview.Text = vSession.User.Overview;
                    //vSession.User.Overview = "";
                    ...
                    #region Reset vSession USer Object

                    vSession.User.Address = "";
                    vSession.User.PersonalImage = "";
                    vSession.User.Position = "";
                    vSession.User.LastName = "";
                    vSession.User.FirstName = "";
                    vSession.User.WebSite = "";
                    vSession.User.Country = "";
                    vSession.User.CompanyLogo = "";
                    vSession.User.TwitterUrl = "";
                    vSession.User.Description = "";
                    vSession.User.CompanyName = "";
        ...
        private void FixDataForCollaborationOrThirdPartyUserRegistration()
        {
            ...
            if (SqlCollaboration.ExistUserInCollaboration(vSession.User.Id, session))
            {
                ...
                if (vSession.User.UserApplicationType == Convert.ToInt32(UserApplicationType.Collaboration) || vSession.User.UserApplicationType == Convert.ToInt32(UserApplicationType.ThirdParty) || SqlCollaboration.HasInvitationRequestByStatus(vSession.User.Id, vSession.User.AccountStatus, vSession.User.CompanyType, CollaborateInvitationStatus.Pending.ToString(), out pendingRequestsCount, session))
                {
                    ...
                    {
                        bool isPartnerVendorResellerUser = SqlCollaboration.IsPartnerVendorResellerUser(vSession.User.Id, session);

                        if (isPartnerVendorResellerUser || vSession.User.UserApplicationType == Convert.ToInt32(UserApplicationType.ThirdParty))
                        {
                            rdBtnUserType.Enabled = false;
                        ...
                        if (isPartnerVendorResellerUser)
                            lblTypeInfo.Text = "You are invited to register as a " + ((isPartnerVendorResellerUser || vSession.User.UserApplicationType == Convert.ToInt32(UserApplicationType.ThirdParty)) ? EnumHelper.GetDescription(Types.Resellers).ToString() : Types.Vendors.ToString()) + " company type";
                        else if (vSession.User.UserApplicationType == (int)UserApplicationType.ThirdParty)
                            lblTypeInfo.Text = "You are suggested to register as a " + EnumHelper.GetDescription(Types.Resellers).ToString() + " company type";
                    }

                    aDennyInvitation.Visible = true;
                    //TextBox tbxCompanyEmail = (TextBox)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "TbxCompanyEmail");
        ...
        protected void RpbRegistrationSteps_ItemClick(object sender, RadPanelBarEventArgs e)
        {
            ...
            HtmlGenericControl divDescription = (HtmlGenericControl)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "divDescription");
            ...
            label37.Text = (rdBtnUserType.SelectedItem.Value == "1")
                            ...
                            : Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("controls", "fullregistration", "label", "13")).Text;
            ...
            if (rdBtnUserType.SelectedItem != null)
                divDescription.Visible = rdBtnUserType.SelectedItem.Value == "1";
        }
        ...
        private bool CheckRegistrationData()
        {
            ...
            Label lblIntegrationProductsError = (Label)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "LblIntegrationProductsError");
            lblIntegrationProductsError.Text = string.Empty;
        ...
        private void GoToNextItem(bool check)
        {
            if (vSession.User != null)
            {
                ...
                RadAutoCompleteBox rcbxIntegrations = (RadAutoCompleteBox)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "RcbxIntegrations");
                RadAutoCompleteBox rcbxProducts = (RadAutoCompleteBox)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "RcbxProducts");
                Label lblIntegrationProducts = (Label)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "LblIntegrationProducts");
                ImageButton imgBtnRemove = (ImageButton)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "ImgBtnRemove");
                ...
                switch (selectedIndex)
                {
                    case 0:
                        ...
                        if (check)
                        {
                            ...
                            if (logoSize != 0)
                            {
                                ...
                                if (user != null)
                                {
                                    user.CompanyLogo = logoTargetFolder + vSession.User.GuId + "/" + formattedName;
                                    vSession.User = null;
                            ...
                            if (rdBtnUserType.SelectedItem != null)
                            {
                                Label label10 = (Label)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "Label10");
                                Label label12 = (Label)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "Label12");

                                bool isVendor = rdBtnUserType.SelectedItem.Value == "1" ? true : false;

                                if (isVendor)
                                {
                                    label10.Text = "Product Integrations";
                                    label12.Text = " (* Add your product integrations)";
                                ...
                                else
                                {
                                    ...
                                    label10.Text = "Products & Partnerships";
                                    label12.Text = " (* Add your products & partnerships, ie: Salesforce, Microsoft Dynamics, Cisco etc.)";
                            ...
                            {
                                Panel pnlIntegrationProducts = (Panel)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "PnlIntegrationProducts");
                                pnlIntegrationProducts.Visible = false;
                            }
                    ...
                    case 1:
                        ...
                        if (check)
                        {
                            ...
                            Label label1 = (Label)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "Label1");
                            bool isVendor = rdBtnUserType.SelectedItem.Value == "1" ? true : false;
                            label1.Text = (isVendor) ? "Select your categories - choose all that apply (maximum 15) (click on titles to expand)" : "Categories - choose all that apply (maximum 15) (click on titles to expand)";
                        }
                    ...
                    case 2:
                        ...
                        #region Hide Description Area

                        if (rdBtnList.SelectedItem != null)
                            divDescription.Visible = rdBtnList.SelectedItem.Value == "1";
                    ...
                    case 3:
                        ...
                        if (check)
                        {
                            ...
                            if (rdBtnUserType.SelectedItem.Value == "1")    //Only for vendors
                            {
                ...
                RpbRegistrationSteps.Items[2].Text = (rdBtnUserType.SelectedItem.Value == "2")
                            ...
                            : "Step 3 of 4 - " + Localizer.GetTranslationResults(vSession.Lang, new XElementInfo("controls", "fullregistration", "item", "9")).Text;
                            ...
                            if (!isError)
                            {
                                ...
                                if (user != null)
                                {
                                    try
                                    {
                                                ...
                                                foreach (string item in list)
                                                {
                                                    ...
                                                    if (itemDescription != "")
                                                    {
                                                        if (itemDescription.StartsWith(" "))
                                                            itemDescription = itemDescription.TrimStart(' ');
                                                        ...
                                                        if (user.CompanyType == Types.Vendors.ToString())
                                                        {
                                                            ...
                                                            if (integration != null)
                                                            {
                                                                bool exist = Sql.ExistUserRegistrationIntegration(user.Id, integration.Id, session);
                                                                if (!exist)
                                                                {
                                                                    ElioUsersRegistrationIntegrations userIntegration = new ElioUsersRegistrationIntegrations();
                                                                    userIntegration.UserId = user.Id;
                                                                    userIntegration.RegIntegrationsId = integration.Id;

                                                                    DataLoader<ElioUsersRegistrationIntegrations> loader = new DataLoader<ElioUsersRegistrationIntegrations>(session);
                                                                    loader.Insert(userIntegration);
                                                                }
                                                            }
                                                        }
                                                        else
                                        ...
                                        #region Insert Product if has Specific Sub Industry Group Items Selected IDs (75,76,77,78,79,89,93,94,121,122,123,124,125)

                                        if (user.CompanyType == EnumHelper.GetDescription(Types.Resellers))
                                        {
                                            try
                                            {
                                                //List<int> productsListIDs = new List<int>(new int[] { 75, 76, 77, 78, 79, 89, 93, 94, 121, 122, 123, 124, 125 });

                                                Sql.InsertProductToUserBySubIndustryGroupItemsIDs(user.Id, session);
                                            }
                                            catch (Exception ex)
                                            {
                                                Logger.DetailedError(Request.Url.ToString(), "ERROR --> Inserting Product for Specific Sub Industry Group Items IDs (75,76,77,78,79,89,93,94,121,122,123,124,125)" + ex.Message.ToString(), ex.StackTrace.ToString());
                                            }
                                        }
        ...
        protected void ImgBtnAdd_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                ImageButton imgBtnRemove = (ImageButton)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "ImgBtnRemove");
                Label lblIntegrationProductsError = (Label)ControlFinder.FindControlRecursive(RpbRegistrationSteps, "LblIntegrationProductsError");
                if (lblIntegrationProductsError != null)
                {
                    lblIntegrationProductsError.Visible = false;
                    lblIntegrationProductsError.Text = "";
                }

                if (rdBtnList.SelectedValue == "1")
                {
                    if (rcbxIntegrations.Text != "")
                        lblIntegrationProducts.Text += rcbxIntegrations.Text + ", ";
                ...
                else
                {
                    if (rcbxProducts.Text != "")
                    {
                        ...
                        {
                            lblIntegrationProductsError.Visible = true;
                            lblIntegrationProductsError.Text = "Sorry, fill product with less than 30 characters for description!";
                            rcbxProducts.Entries.Clear();
