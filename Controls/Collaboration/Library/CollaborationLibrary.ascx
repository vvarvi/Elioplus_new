<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CollaborationLibrary.ascx.cs" Inherits="WdS.ElioPlus.Controls.Collaboration.Library.CollaborationLibrary" %>
                                                ...
                                                <ContentTemplate>
                                                    <div id="divVendorsUploadFilesArea" runat="server" class="navi navi-hover navi-active navi-link-rounded navi-bold d-flex flex-row">
                                                        ...
                                                        <div class="navi-item mr-2">
                                                            <asp:TextBox ID="TbxFileTitle" Width="120" CssClass="form-control" placeholder="File title" runat="server" />
                                                        </div>
                                                        <!--end::Item-->                                                        
                                                        <!--begin::Item-->
                                                        <div class="navi-item mr-2">
                                                        ...
                                                        <!--end::Item-->
                                                        <!--begin::Item-->
                                                        <div class="navi-item mr-2" style="width: 185px;">
                                                            <div id="divFileUpload" class="fileinput fileinput-new" data-provides="fileinput" runat="server">
                                                                <div class="">
                                                                    <span>
                                                                        <input type="file" name="uploadFile" id="inputFile" style="width: 185px !important;" data-buttonname="btn btn-light-primary"
