...
{
    public partial class LibraryViewSendControl : System.Web.UI.UserControl
    {
        ...
        public string FileTitle
        {
            get
            {
                if (ViewState["FileTitle"] != null)
                    return ViewState["FileTitle"].ToString();
                else
                    return "";
            }
            set
            {
                ViewState["FileTitle"] = value;
            }
        }
        ...
        private void FixPage(DBSession session)
        {
            UpdateStrings();
            SetLinks();
            //LoadFileTypes();
            FillDropLists(session);
            FixTabsContent(1);
        ...
        public void FillDropLists(DBSession session)
        {
            ...
            if (defaultCategories.Count > 0)
            {
                ...
                Ddlcategory.SelectedValue = defaultCategories[0].Id.ToString();
                Ddlcategory.SelectedItem.Text = defaultCategories[0].CategoryDescription;
            }
        }
        ...
        public void FixTabsContent(int tab)
        {
        ...
        private void BuildRepeaterItem(RepeaterItemEventArgs args)
        {
            ...
            if (item != null)
            {
                ...
                if (row != null)
                {
                    ...
                    if (div1.Visible)
                    {
                        CheckBox cbx = (CheckBox)ControlFinder.FindControlRecursive(item, "Cbx1");
                        cbx.Checked = false;
                        ...
                        if (!string.IsNullOrEmpty(row["file_title1"].ToString()))
                        {
                        ...
                        {
                            if (row["file_name1"].ToString().Length >= 45)
                            {
                                lbl1.Text = row["file_name1"].ToString().Substring(0, 45) + "...";
                            }
                            else
                            {
                    ...
                    if (div2.Visible)
                    {
                        CheckBox cbx = (CheckBox)ControlFinder.FindControlRecursive(item, "Cbx2");
                        cbx.Checked = false;
                        ...
                        if (!string.IsNullOrEmpty(row["file_title2"].ToString()))
                        {
                        ...
                        {
                            if (row["file_name2"].ToString().Length >= 45)
                            {
                                lbl2.Text = row["file_name2"].ToString().Substring(0, 45) + "...";
                            }
                            else
                            {
                    ...
                    if (div3.Visible)
                    {
                        CheckBox cbx = (CheckBox)ControlFinder.FindControlRecursive(item, "Cbx3");
                        cbx.Checked = false;
                        ...
                        if (!string.IsNullOrEmpty(row["file_title3"].ToString()))
                        {
                        ...
                        {
                            if (row["file_name3"].ToString().Length >= 45)
                            {
                                lbl3.Text = row["file_name3"].ToString().Substring(0, 45) + "...";
                            }
                            else
                            {
                    ...
                    if (div4.Visible)
                    {
                        CheckBox cbx = (CheckBox)ControlFinder.FindControlRecursive(item, "Cbx4");
                        cbx.Checked = false;
                        ...
                        if (!string.IsNullOrEmpty(row["file_title4"].ToString()))
                        {
                        ...
                        {
                            if (row["file_name4"].ToString().Length >= 45)
                            {
                                lbl4.Text = row["file_name4"].ToString().Substring(0, 45) + "...";
                            }
                            else
                            {
        ...
        private void ShowSelectedFileToChat(bool showFile)
        {
            Label lblLibrarySelectedFile = (Label)ControlFinder.FindControlBackWards(this, "LblLibrarySelectedFile");
            HiddenField hdnCategoryId = (HiddenField)ControlFinder.FindControlBackWards(this, "HdnCategoryId");
            HiddenField hdnFileId = (HiddenField)ControlFinder.FindControlBackWards(this, "HdnFileId");

            if (lblLibrarySelectedFile != null && hdnCategoryId != null && hdnFileId != null)
            {
                ...
                if (showFile)
                {
                    lblLibrarySelectedFile.Text = Ddlcategory.SelectedItem.Text + "/" + FileTitle;
                    hdnCategoryId.Value = Ddlcategory.SelectedItem.Value;
                    hdnFileId.Value = FileIdToDelete.ToString();
                }
            }

            HtmlGenericControl divLibrarySelectedFile = (HtmlGenericControl)ControlFinder.FindControlBackWards(this, "divLibrarySelectedFile");
            if (divLibrarySelectedFile != null)
            {
                divLibrarySelectedFile.Visible = (showFile) ? true : false;
            }

            HtmlGenericControl divUpload = (HtmlGenericControl)ControlFinder.FindControlBackWards(this, "divUpload");
            if (divUpload != null)
            {
                divUpload.Visible = false;
            }

            UpdatePanel updatePanel1 = (UpdatePanel)ControlFinder.FindControlBackWards(this, "UpdatePanel1");
            if (updatePanel1 != null)
            {
                updatePanel1.Update();
            }

            System.Web.UI.ScriptManager.RegisterStartupScript(this, GetType(), "Open Modal Popup", "CloseLibraryPopUp();", true);
        }
                    ...
                    try
                    {
                        ...
                        if (successUpload)
                        {
                            try
                            {
                                ...
                                libraryFile.FileTitle = libraryFile.FileName;    //(TbxFileTitle.Text != "") ? "Library_" + TbxFileTitle.Text.Replace(" ", "_").Trim() : (fileName.Length <= 150) ? fileName : fileName.Substring(0, 149);
                                ...
                                bool success = true;    //GlobalDBMethods.ReduceUserFileStorage(vSession.User.Id, Convert.ToDouble(fileContent.ContentLength), session);
                                if (!success)
        ...
        protected void Ddlcategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    FixTabsContent(Convert.ToInt32(Ddlcategory.SelectedItem.Value));
                }
            }
            catch (Exception ex)
            {
                ...
                if (cbx != null)
                {
                    if (cbx.Checked)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            HiddenField hdnCategoryId = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnCategoryId1");
                            HiddenField hdnFileName = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnFileName1");
                            Label lbl = (Label)ControlFinder.FindControlRecursive(item, "Lbl1");

                            if (hdnId != null && hdnCategoryId != null && hdnFileName != null && lbl != null)
                            {
                                FileIdToDelete = Convert.ToInt32(hdnId.Value);
                                FileCategoryIdToDelete = Convert.ToInt32(hdnCategoryId.Value);
                                FileNameToDelete = hdnFileName.Value;
                                FileTitle = lbl.Text;
                                ShowSelectedFileToChat(true);
                            }
                        }
                    }
                    else
                        ShowSelectedFileToChat(false);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void Cbx2_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                CheckBox cbx = (CheckBox)sender;
                if (cbx != null)
                {
                    if (cbx.Checked)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            HiddenField hdnCategoryId = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnCategoryId2");
                            HiddenField hdnFileName = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnFileName2");
                            Label lbl = (Label)ControlFinder.FindControlRecursive(item, "Lbl2");
        ...
        protected void Cbx3_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                CheckBox cbx = (CheckBox)sender;
                if (cbx != null)
                {
                    if (cbx.Checked)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            HiddenField hdnCategoryId = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnCategoryId3");
                            HiddenField hdnFileName = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnFileName3");
                            Label lbl = (Label)ControlFinder.FindControlRecursive(item, "Lbl3");
        ...
        protected void Cbx4_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                CheckBox cbx = (CheckBox)sender;
                if (cbx != null)
                {
                    if (cbx.Checked)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            HiddenField hdnCategoryId = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnCategoryId4");
                            HiddenField hdnFileName = (HiddenField)ControlFinder.FindControlRecursive(item, "HdnFileName4");
                            Label lbl = (Label)ControlFinder.FindControlRecursive(item, "Lbl4");
