...
{
    public partial class DashboardDealPartnerManage : System.Web.UI.Page
    {
        ...
        private void FixPage()
        {
            if (!IsPostBack)
            {
                divPgToolbar.Visible = divSearchAreaConfirmed.Visible = vSession.User.CompanyType == Types.Vendors.ToString();
        ...
        protected void RdgSendInvitationsConfirmed_OnPageIndexChanged(object sender, Telerik.Web.UI.GridPageChangedEventArgs e)
        {
            try
            {
