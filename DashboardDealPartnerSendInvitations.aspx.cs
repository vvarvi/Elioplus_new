...
{
    public partial class DashboardDealPartnerSendInvitations : System.Web.UI.Page
    {
        ...
        {
            aCancelInvitation.HRef = ControlLoader.Dashboard(vSession.User, "manage-partners");
        }
        ...
        private void UpdateStrings()
        {
            ...
            if (vSession.User.CompanyType == Types.Vendors.ToString())
            {
                ...
                LblTitleInvite2.Text = "Use the following button to send email invitations to your partners to join your partner porlal";
