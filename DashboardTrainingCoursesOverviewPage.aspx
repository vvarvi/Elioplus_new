<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardTrainingCoursesOverviewPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardTrainingCoursesOverviewPage" %>
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="Actions">
                                                        <ItemTemplate>
                                                            ...
                                                            <span class="symbol-label p-1">
                                                                <a id="aSend" runat="server" title="Analytics" class="navi-link">
                                                                    <span class="navi-icon">
