...
{
    public partial class DashboardTrainingAnalyticsPage : System.Web.UI.Page
    {
        ...
        {
            aAddCourse.HRef = ControlLoader.Dashboard(vSession.User, "partner-training-add-new");
        }
            ...
            try
            {
                ...
                if (e.Item is GridDataItem && e.Item.OwnerTableView.Name == "Parent")
                {
                    ...
                    if (course != null)
                    {
                        ...
                        HtmlAnchor aViewPartners = (HtmlAnchor)ControlFinder.FindControlRecursive(item, "aViewPartners");
                        aViewPartners.HRef = ControlLoader.Dashboard(vSession.User, item["id"].Text + "/course-training-analytics");
                    }
        ...
        protected void RdgElioUsers_OnNeedDataSource(object sender, EventArgs args)
        {
            try
            {
                ...
                {
                    LblCourses.Text = "Your Training Library contains " + courses.Count + " courses";
                ...
                {
                    LblCourses.Text = "Your Training Library contains 0 courses";
