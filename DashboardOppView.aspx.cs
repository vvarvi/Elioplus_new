...
{
    public partial class DashboardOppView : System.Web.UI.Page
    {
        ...
        */
        ...
        private DataTable LoadOp(OpportunityStep step)
        {
            ...
            if (vSession.User != null)
            {
                ...
                if (DdlOpportKinds.SelectedValue == "0")
                {
                    opportunities = Sql.GetUsersOpportunitiesByNameAndStatus(vSession.User.Id, step.ToString(), TbxSearch.Text, session);
                }
                else if (DdlOpportKinds.SelectedValue == "1")
                {
                    opportunities = Sql.GetUsersOpportunitiesWithOpenTasksByStepByName(vSession.User.Id, step.ToString(), TbxSearch.Text, session);
                }
                ...
                if (opportunities.Count > 0)
                {
                    ...
                    table.Columns.Add("organizationUserId");
                    table.Columns.Add("companyLogo");
                    ...
                    foreach (ElioOpportunitiesUsersIJUsersIJStatus opportunity in opportunities)
                    {
                        ...
                        table.Rows.Add(opportunity.Id, opportunity.OrganizationName, notesCount, tasksCount, opportunity.SysDate, opportunity.OrganizationUserId, opportunity.CompanyLogo);
                    }
                }
            }
        ...
        protected void RdgContacts_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    Image img1 = (Image)ControlFinder.FindControlRecursive(itm, "Img1");
                    img1.ImageUrl = (!string.IsNullOrEmpty(itm["companyLogo"].Text.ToString()) && itm["companyLogo"].Text != "&nbsp;") ? itm["companyLogo"].Text : "~/Images/no_logo.jpg";    //"/images/sidebar_inline_toggler_icon_grey.jpg";
                    img1.CssClass = "imgClass";
                    
                    Label lblOpportunityId = (Label)ControlFinder.FindControlRecursive(itm, "LblOpportunityId");
                    lblOpportunityId.Text = itm["opportId"].Text.ToString();
                    lblOpportunityId.Visible = false;
                    
                    Label lblCompanyname = (Label)ControlFinder.FindControlRecursive(itm, "LblCompanyname");
                    lblCompanyname.Text = itm["opportOrganName"].Text.ToString();
                    lblCompanyname.CssClass = "nameClass";
                    ...
                    HyperLink hpNotes = (HyperLink)ControlFinder.FindControlRecursive(itm, "HpNotes");
                    int notesCount = Convert.ToInt32(itm["opportNotes"].Text);
                    hpNotes.Text = "<b>" + notesCount + "</b> Notes";
                    hpNotes.CssClass = "noteClass";
                    hpNotes.NavigateUrl = ControlLoader.Dashboard(vSession.User, "opportunities-view-notes") + "?opportunityViewID=" + sessionId + "&btn=true";
                    ...
                    if (oppNotes.Count > 0)
                    {
                        hpNotes.ToolTip = GlobalMethods.FillToolTipWithStrings(oppNotes);
                    }

                    HyperLink hpTasks = (HyperLink)ControlFinder.FindControlRecursive(itm, "HpTasks");
                    int tasksCount = Convert.ToInt32(itm["opportTasks"].Text);
                    hpTasks.Text = "<b>" + tasksCount + "</b> Tasks";
                    hpTasks.CssClass = "taskClass";
                    hpTasks.NavigateUrl = ControlLoader.Dashboard(vSession.User, "opportunities-view-tasks") + "?opportunityViewID=" + sessionId;
                    
                    HtmlAnchor aEditOpportunity = (HtmlAnchor)ControlFinder.FindControlRecursive(itm, "aEditOpportunity");
                    aEditOpportunity.HRef = ControlLoader.Dashboard(vSession.User, "opportunities-add-edit") + "?opportunityViewID=" + sessionId;

                    Image imgEditOpportunity = (Image)ControlFinder.FindControlRecursive(itm, "ImgEditOpportunity");                    
                    imgEditOpportunity.ImageUrl = "/images/settings.png";
                    imgEditOpportunity.CssClass = "settClass";
                    
                    Label lblEditOpportunity = (Label)ControlFinder.FindControlRecursive(itm, "LblEditOpportunity");                    
                    lblEditOpportunity.Text = "View / Edit";
                    lblEditOpportunity.Width = Unit.Pixel(76);
                    //lblEditOpportunity.CssClass = "settClass";
                    lblEditOpportunity.Style.Add("margin-right", "10px");
                    ...
                    HtmlAnchor ancRight = (HtmlAnchor)itm.FindControl("aMoveRight");
                    HtmlAnchor ancDelete = (HtmlAnchor)itm.FindControl("aDelete");
                    ancRight.Title = "Move to " + LblStatusTwo.Text + "";
                    ancDelete.Title = "Delete";
        ...
        protected void RdgContacts_OnNeedDataSource(object sender, EventArgs args)
        {
            try
            {
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    if (DdlContactSort.SelectedItem.Value == "0")
                    {
                        dv.Sort = "opportDate desc";
                    }
                    else if (DdlContactSort.SelectedItem.Value == "1")
                    {
                        dv.Sort = "opportOrganName asc";
                    }
                    else if (DdlContactSort.SelectedItem.Value == "2")
                    {
                        dv.Sort = "opportNotes desc";
                    }
                    else if (DdlContactSort.SelectedItem.Value == "3")
                    {
                        dv.Sort = "opportTasks desc";
                    }

                    DataTable sortDt = dv.ToTable();

                    RdgContacts.DataSource = sortDt;
                }
                else
                {
                    LblAllContacts.Text = "0";
                    RdgContacts.Visible = false;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void RdgMeeting_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    hpNotes.Text = "<b>" + notesCount + "</b> Notes";
                    hpNotes.CssClass = "noteClass";
                    hpNotes.NavigateUrl = ControlLoader.Dashboard(vSession.User, "opportunities-view-notes") + "?opportunityViewID=" + guid + "&btn=true";
                    ...
                    hpTasks.Text = "<b>" + tasksCount + "</b> Tasks";
                    hpTasks.CssClass = "taskClass";
                    hpTasks.NavigateUrl = ControlLoader.Dashboard(vSession.User, "opportunities-view-tasks") + "?opportunityViewID=" + guid;
                    ...
                    HtmlAnchor ancRight = (HtmlAnchor)itm.FindControl("aMoveRight");
                    HtmlAnchor ancLeft = (HtmlAnchor)itm.FindControl("aMoveLeft");
                    HtmlAnchor ancDelete = (HtmlAnchor)itm.FindControl("aDelete");
                    ancRight.Title = "Move to " + LblStatusThree.Text + "";
                    ancLeft.Title = "Move to " + LblStatusOne.Text + "";
                    ancDelete.Title = "Delete";
        ...
        protected void RdgMeeting_OnNeedDataSource(object sender, EventArgs args)
        {
            try
            {
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    RdgMeeting.DataSource = sortDt;                   
                }
                else
                {
                    LblAllMeeting.Text = "0";
                    RdgMeeting.Visible = false;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void RdgProposal_OnNeedDataSource(object sender, EventArgs args)
        {
            try
            {
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    RdgProposal.DataSource = sortDt;
                }
                else
                {
                    LblAllProposal.Text = "0";
                    RdgProposal.Visible = false;
                }
            }
            catch (Exception ex)
            {
        ...
        protected void RdgClosed_OnItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    //itm.Value = itm["opportId"].Text.ToString();
                    itm.ToolTip = Convert.ToInt32(OpportunityStep.Closed).ToString();
                    ...
                    if (subStatus.Count > 0)
                    {
                        Label lblSubStatus = (Label)ControlFinder.FindControlRecursive(itm, "LblSubStatus");
                        lblSubStatus.Text = "Status ";
                        lblSubStatus.CssClass = "stClass";

                        RadComboBox rcbxSubStatus = (RadComboBox)ControlFinder.FindControlRecursive(itm, "RcbxSubStatus");
                        rcbxSubStatus.Items.Clear();
                        ...
                        rcbxSubStatus.FindItemByValue((opportunitySubCategory != null) ? opportunitySubCategory.SubCategoriesStatusId.ToString() : "0").Selected = true;

                        rcbxSubStatus.Width = 115;
                        rcbxSubStatus.Style.Add("float", "right");
                        rcbxSubStatus.Style.Add("margin-top", "-38px");
                        rcbxSubStatus.Style.Add("margin-right", "20px");

                        ImageButton imgBtnSaveSub = (ImageButton)ControlFinder.FindControlRecursive(itm, "ImgBtnSaveSub");
                        imgBtnSaveSub.ImageUrl = "/images/save.png";
                        imgBtnSaveSub.CssClass = "saveClass";
                        //imgBtnSaveSub.Click += new System.Web.UI.ImageClickEventHandler(ImgBtnSaveSub_Click);                        
                    }
        ...
        protected void RdgClosed_OnNeedDataSource(object sender, EventArgs args)
        {
            try
            {
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    RdgClosed.DataSource = sortDt;
                }
                else
                {
                    LblAllClosed.Text = "0";
                    RdgClosed.Visible = false;
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (vSession.User != null)
                {
                    ...
                    if (DdlClosedSubStatusSort.SelectedItem.Value != "0")
                    {
                        ...
                        tblOp.Columns.Add("opportId");
                        tblOp.Columns.Add("opportOrganName");
                        tblOp.Columns.Add("opportNotes");
                        tblOp.Columns.Add("opportTasks");
                        tblOp.Columns.Add("opportDate");

                        foreach (DataRow row in table.Rows)
                        {
                            bool exists = Sql.HasUserOpportunitySpecificSubCategoryStatus(vSession.User.Id, Convert.ToInt32(row["opportId"]), null, Convert.ToInt32(DdlClosedSubStatusSort.SelectedItem.Value), session);

                            if (exists)
                            { 
                                tblOp.Rows.Add(row["opportId"], row["opportOrganName"], row["opportNotes"], row["opportTasks"], row["opportDate"]);
                            }
                        }

                        RdgClosed.DataSource = tblOp;
                    }
                    else
                    {
        ...
        protected void ImgBtnSaveSub_OnClick(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            try
            {
                if (vSession.User != null)
                {
                    ...
                    RadComboBox rcbxSubStatus = (RadComboBox)ControlFinder.FindControlRecursive(item, "RcbxSubStatus");

                    if (rcbxSubStatus != null)
                    {
                        int selectedSubCategoryId = Convert.ToInt32(rcbxSubStatus.SelectedValue);
                        ...
                        int opportunityId = int.Parse(item["opportId"].Text.ToString());
        ...
        protected void BtntContactSort_OnClick(object sender, EventArgs args)
        {
            try
            {
                if (vSession.User != null)
        ...
        protected void BtntMeetingSort_OnClick(object sender, EventArgs args)
        {
            try
            {
                if (vSession.User != null)
        ...
        protected void BtntProposalSort_OnClick(object sender, EventArgs args)
        {
            try
            {
                if (vSession.User != null)
        ...
        protected void BtntClosedSort_OnClick(object sender, EventArgs args)
        {
            try
            {
                if (vSession.User != null)
