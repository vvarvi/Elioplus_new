...
{
    public partial class ElioUsersMultiAccountsIJUsers : DataObject
    {
        /// <summary>
        /// Database Field : id
        /// </summary>
        ...
        /// <summary>
        /// Database Field : has_discount_coupon
        /// </summary>
        [FieldInfo("has_discount_coupon")]
        public int HasDiscountCoupon { get; set; }
    }
}
