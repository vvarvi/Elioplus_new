<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDashboard.Master" AutoEventWireup="true" CodeBehind="DashboardCollaborationLibraryPage.aspx.cs" Inherits="WdS.ElioPlus.DashboardCollaborationLibraryPage" %>
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanelContent" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div class="d-flex flex-row">
                        <!--begin::Aside-->
                        <div class="flex-row-auto offcanvas-mobile w-200px w-xxl-275px" id="kt_todo_aside" style="min-height: 660px !important; padding-bottom: 25px; display: inline-table;">
                            <!--begin::Card-->
                                                    ...
                                                    <ContentTemplate>
                                                        <div id="divVendorsUploadFilesArea" runat="server" class="navi navi-hover navi-active navi-link-rounded navi-bold d-flex flex-row">
                                                            ...
                                                            <div class="navi-item mr-2">
                                                                <asp:DropDownList ID="Ddlcategory" Width="220" CssClass="form-control" runat="server" />
                                                            </div>
                                                            <!--end::Item-->
                                                            <!--begin::Item-->
