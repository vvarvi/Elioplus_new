<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelPaymentPage.aspx.cs" Inherits="WdS.ElioPlus.CancelPaymentPage" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                        <div style="text-align: center; width: 280px;">
                                            <h3>
                                                <asp:Label ID="LblSuccessRegistration" runat="server" Text="Your payment has been canceled and no charge was made!" />
                                            </h3>
                                        </div>
                                    </div>
