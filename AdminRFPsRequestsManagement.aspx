<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="AdminRFPsRequestsManagement.aspx.cs" Inherits="WdS.ElioPlus.Management.AdminRFPsRequestsManagement" %>
                            ...
                            <asp:Panel ID="PnlSearch" Style="border-radius: 5px; background-color: #F0F3CD; margin-bottom: 10px; padding: 30px 10px 30px 10px; margin: auto; position: relative;" runat="server">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="width: 130px;">
                                            <div style="padding: 5px;">
                                                <asp:Label ID="Label3" CssClass="label_title" Text="Date to get leads" runat="server" />
                                            </div>
                                        </td>
                                        <td>
                                            <div style="padding: 5px;">
                                                <telerik:RadDatePicker ID="RdtLeadsPicker" Width="300" runat="server" />
                                            </div>
                                        </td>
                                        <td style="width: 130px;">
                                            <div style="padding: 5px;">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <telerik:RadButton ID="RbtnGetLeads" Style="text-align: center;" OnClick="RbtnGetLeads_Click" runat="server">
                                                <ContentTemplate>
                                                    <span>
                                                        <asp:Label ID="LblGetLeadsText" Text="Get leads" runat="server" />
                                                    </span>
                                                </ContentTemplate>
                                            </telerik:RadButton>
                                        </td>
                                                ...
                                                <telerik:RadGrid ID="RdgElioUsersDemoRequests" Style="margin: auto; position: relative;" AllowPaging="true" AllowSorting="false" HeaderStyle-BackColor="#39b4ef" PagerStyle-Position="TopAndBottom" HeaderStyle-ForeColor="#ffffff" PageSize="10" Width="100%" CssClass="rgdd" OnNeedDataSource="RdgElioUsersDemoRequests_OnNeedDataSource" OnItemDataBound="RdgElioUsersDemoRequests_OnItemDataBound" AutoGenerateColumns="false" runat="server">
                                                    <MasterTableView Width="100%" DataKeyNames="id" Name="Parent" AllowMultiColumnSorting="true">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn HeaderStyle-Width="100" HeaderText="Company country" DataField="lead_country" UniqueName="lead_country" />
                                                            <telerik:GridBoundColumn Display="false" HeaderText="Product" DataField="product" UniqueName="product" />
                                                            <telerik:GridTemplateColumn HeaderStyle-Width="160" HeaderText="Product">
                                                                <ItemTemplate>
                                                                    <div style="float: left; display: inline-block;">
                                                                        <asp:Label ID="LblProduct" runat="server" />                                                                        
                                                                        <asp:TextBox ID="TbxProduct" runat="server" Visible="false" Width="140" />
                                                                    </div>
                                                                    <div style="float: right; display: inline-block;">
                                                                        <asp:Image ID="ImgProductInfo" Visible="false" Style="cursor: pointer;" AlternateText="info" ImageUrl="~/images/icons/small/info.png" Width="20" Height="20" runat="server" />
                                                                        <telerik:RadToolTip ID="RttImgProductInfo" Visible="false" TargetControlID="ImgProductInfo" Width="400" Title="Info" Text="You can not edit these products because it's more than one saved for this RFQ. Please contact Administrator in order to fix it!" AutoCloseDelay="10000" HideEvent="ManualClose" Position="TopRight" Animation="Fade" runat="server" />
                                                                        ...
                                                                        <asp:ImageButton ID="ImgBtnSave" Visible="false" OnClick="ImgBtnSave_OnClick" ImageUrl="~/Images/save.png" runat="server" />
                                                                    </div>
                                                                </ItemTemplate>
